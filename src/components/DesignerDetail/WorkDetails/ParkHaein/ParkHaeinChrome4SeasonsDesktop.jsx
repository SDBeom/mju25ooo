...
const ParkHaeinChrome4SeasonsDesktop = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--park-haein-chrome-4-seasons-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--park-haein-chrome-4-seasons-desktop">
            ...
            <div className="work-detail__ctas work-detail__ctas--park-haein-chrome-4-seasons-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--park-haein-chrome-4-seasons-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--park-haein-chrome-4-seasons-desktop">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--park-haein-chrome-4-seasons-desktop">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--park-haein-chrome-4-seasons-desktop"
          />
        </div>
      </section>

      {/* Feature 3 */}
      <section className="work-detail__section work-detail__feature work-detail__feature--park-haein-chrome-4-seasons-desktop">
...
The freshness of spring, the heat of summer, the depth of autumn, and the stillness of winter intertwine with the bold identity of Chrome. Viewers can follow the flow and transformation of the seasons without complex interpretation, discovering new details and pleasures within each scene. At the intersection of digital and reality, humanity and brand, the visual experience expands—freely stimulating the viewer's senses and imagination.`}
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--park-haein-chrome-4-seasons-desktop">
        <li className="work-detail__feature-card work-detail__feature-card--park-haein-chrome-4-seasons-desktop">
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--park-haein-chrome-4-seasons-desktop">
        <li className="work-detail__bento-card work-detail__bento-card--park-haein-chrome-4-seasons-desktop">
      ...
      {/* Text 1 */}
      <section className="work-detail__section work-detail__text-section work-detail__text-section--park-haein-chrome-4-seasons-desktop">
...
export default ParkHaeinChrome4SeasonsDesktop;
