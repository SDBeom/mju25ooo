...
import '../../styles/works/ParkHaeinChrome4Seasons/ParkHaeinChrome4SeasonsTablet.css';
...
/**
 * 박해인 - Chrome 4: Seasons Tablet 버전
 * Figma 디자인 기반 구현 (800px)
 */
const ParkHaeinChrome4SeasonsTablet = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--park-haein-chrome-4-seasons-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--park-haein-chrome-4-seasons-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--park-haein-chrome-4-seasons-tablet">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--park-haein-chrome-4-seasons-tablet">
              Chrome 4: Seasons
            </h2>
            <p className="work-detail__lead work-detail__lead--park-haein-chrome-4-seasons-tablet">
              Chrome 4: Seasons는 크롬하츠(Chrome Hearts)의 강렬한 아이덴티티를 디지털 휴먼을 매개로 재해석한 비주얼 브랜드 필름이다.
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--park-haein-chrome-4-seasons-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--park-haein-chrome-4-seasons-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--park-haein-chrome-4-seasons-tablet">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--park-haein-chrome-4-seasons-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--park-haein-chrome-4-seasons-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--park-haein-chrome-4-seasons-tablet"
          />
        </div>
      </section>

      {/* Feature 3 */}
      <section className="work-detail__section work-detail__feature work-detail__feature--park-haein-chrome-4-seasons-tablet">
...
The freshness of spring, the heat of summer, the depth of autumn, and the stillness of winter intertwine with the bold identity of Chrome. Viewers can follow the flow and transformation of the seasons without complex interpretation, discovering new details and pleasures within each scene. At the intersection of digital and reality, humanity and brand, the visual experience expands—freely stimulating the viewer's senses and imagination.`}
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--park-haein-chrome-4-seasons-tablet">
        <li className="work-detail__feature-card work-detail__feature-card--park-haein-chrome-4-seasons-tablet">
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--park-haein-chrome-4-seasons-tablet">
        <li className="work-detail__bento-card work-detail__bento-card--park-haein-chrome-4-seasons-tablet">
        ...
        <li className="work-detail__bento-card work-detail__bento-card--park-haein-chrome-4-seasons-tablet work-detail__bento-card--wide">
          <div className="work-detail__bento-image-wrapper">
            <img
        ...
        <li className="work-detail__bento-card work-detail__bento-card--park-haein-chrome-4-seasons-tablet work-detail__bento-card--full">
          <div className="work-detail__bento-image-wrapper">
            <img
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--park-haein-chrome-4-seasons-tablet">
      ...
      <section className="work-detail__section work-detail__instagram-card work-detail__instagram-card--park-haein-chrome-4-seasons-tablet">
        <a
      ...
      {/* Text 1 */}
      <section className="work-detail__section work-detail__text-section work-detail__text-section--park-haein-chrome-4-seasons-tablet">
...
export default ParkHaeinChrome4SeasonsTablet;
