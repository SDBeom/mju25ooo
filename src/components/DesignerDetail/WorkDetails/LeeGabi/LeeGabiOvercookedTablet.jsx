 ...
 */
const LeeGabiOvercookedTablet = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--leegabi-overcooked-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--leegabi-overcooked-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--leegabi-overcooked-tablet">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--leegabi-overcooked-tablet">
              {`OVERCOOKED
: 카페 대소동`}
            </h2>
            <p className="work-detail__lead work-detail__lead--leegabi-overcooked-tablet">
              {`이전 식당을 운영하다 폭싹 망해버린 요리사들.
이번엔 카페다! 양파왕의 제안으로 카페에서 일하며 벌어지는 재미난 이야기.`}
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--leegabi-overcooked-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--leegabi-overcooked-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--leegabi-overcooked-tablet">
          <img
            src={leegabiWork1_01}
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--leegabi-overcooked-tablet">
        ...
        <li className="work-detail__bento-card work-detail__bento-card--large work-detail__bento-card--leegabi-overcooked-tablet">
          <div className="work-detail__bento-image-wrapper">
            <img
              src={leegabiWork1_04}
              alt="카페 운영 시작!"
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--leegabi-overcooked-tablet">
      ...
      {/* Feature Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--leegabi-overcooked-tablet">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--leegabi-overcooked-tablet">
          <img
            src={leegabiWork1_12}
            alt="MISSION CLEAR!"
...
export default LeeGabiOvercookedTablet;
