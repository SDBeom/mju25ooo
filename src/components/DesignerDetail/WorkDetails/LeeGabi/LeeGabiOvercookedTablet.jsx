 ...
 */
const LeeGabiOvercookedTablet = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--leegabi-overcooked-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--leegabi-overcooked-tablet">
          <div className="work-detail__text-group">
            ...
            <div className="work-detail__lead work-detail__lead--leegabi-overcooked-tablet">
          ...
          <div className="work-detail__gallery-column">
            <div className="work-detail__gallery-item">
              <img
                ...
                alt="Gallery image 3"
                className="work-detail__gallery-image"
                onError={(e) => handleImageError(e, leegabiWork1_05, work.id, 'gallery-3')}
                loading="lazy"
              />
            </div>
            <div className="work-detail__gallery-item">
            ...
            <div className="work-detail__gallery-item">
              <img
                ...
                alt="Gallery image 5"
                className="work-detail__gallery-image"
                onError={(e) => handleImageError(e, leegabiWork1_07, work.id, 'gallery-5')}
                loading="lazy"
              />
            </div>
          </div>
