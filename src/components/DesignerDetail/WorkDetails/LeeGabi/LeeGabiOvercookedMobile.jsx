...
const LeeGabiOvercookedMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--leegabi-overcooked-mobile">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--leegabi-overcooked-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--leegabi-overcooked-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--leegabi-overcooked-mobile"
          />
        </div>
      </section>
