 ...
 */
const LeeGabiOvercookedDesktop = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }
  ...
  return (
    <div className="work-detail work-detail--leegabi-overcooked-desktop">
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--leegabi-overcooked-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--leegabi-overcooked-desktop">
          <div className="work-detail__text-group">
            ...
            <div className="work-detail__lead work-detail__lead--leegabi-overcooked-desktop">
              <p className="mb-0">이전 식당을 운영하다 폭싹 망해버린 요리사들.</p>
              <p>이번엔 카페다! 양파왕의 제안으로 카페에서 일하며 벌어지는 재미난 이야기.</p>
            </div>
          </div>
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--leegabi-overcooked-desktop">
        <li className="work-detail__bento-card work-detail__bento-card--leegabi-overcooked-desktop">
