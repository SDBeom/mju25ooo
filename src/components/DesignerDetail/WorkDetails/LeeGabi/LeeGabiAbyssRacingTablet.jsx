...
const LeeGabiAbyssRacingTablet = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--leegabi-abyss-racing-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--leegabi-abyss-racing-tablet">
            ...
            <div className="work-detail__ctas work-detail__ctas--leegabi-abyss-racing-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--leegabi-abyss-racing-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--leegabi-abyss-racing-tablet">
          <img
            src={leegabiWork2_01}
      ...
      {/* Feature Section 1 */}
      <section className="work-detail__section work-detail__feature work-detail__feature--leegabi-abyss-racing-tablet">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--leegabi-abyss-racing-tablet">
          <img
            src={leegabiWork2_02}
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--leegabi-abyss-racing-tablet">
        <li className="work-detail__feature-row work-detail__feature-row--leegabi-abyss-racing-tablet">
        ...
        <li className="work-detail__feature-row work-detail__feature-row--reverse work-detail__feature-row--leegabi-abyss-racing-tablet">
          <div className="work-detail__feature-image-wrapper">
            <img
              src={leegabiWork2_05}
              alt="세이렌의 보물"
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--leegabi-abyss-racing-tablet">
        <li className="work-detail__card work-detail__card--leegabi-abyss-racing-tablet">
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--leegabi-abyss-racing-tablet">
        <li className="work-detail__bento-card work-detail__bento-card--leegabi-abyss-racing-tablet">
        ...
        <li className="work-detail__bento-card work-detail__bento-card--large work-detail__bento-card--leegabi-abyss-racing-tablet">
          <div className="work-detail__bento-image-wrapper">
            <img
              src={leegabiWork2_11}
              alt="마지막 질주"
...
export default LeeGabiAbyssRacingTablet;
