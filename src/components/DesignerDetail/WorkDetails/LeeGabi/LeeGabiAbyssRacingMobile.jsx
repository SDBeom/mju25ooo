...
// 이미지 임포트
import leegabiWork2_01 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_01.webp';
import leegabiWork2_02 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_02.webp';
import leegabiWork2_03 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_03.webp';
import leegabiWork2_04 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_04.webp';
import leegabiWork2_05 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_05.webp';
import leegabiWork2_06 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_06.webp';
import leegabiWork2_07 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_07.webp';
import leegabiWork2_08 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_08.webp';
import leegabiWork2_09 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_09.webp';
import leegabiWork2_10 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_10.webp';
import leegabiWork2_11 from '../../../../assets/이가비/이가비_게임콘텐츠츠_작품2_11.webp';
...
const LeeGabiAbyssRacingMobile = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--leegabi-abyss-racing-mobile">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--leegabi-abyss-racing-mobile">
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--leegabi-abyss-racing-mobile">
          <img
            src={leegabiWork2_01}
        ...
        <div className="work-detail__hero-content work-detail__hero-content--leegabi-abyss-racing-mobile">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--leegabi-abyss-racing-mobile">
              <span className="block mb-0">Abyss Racing</span>
              <span className="block mb-0">:세이렌의</span>
              <span className="block">보물</span>
            </h2>
            <div className="work-detail__lead work-detail__lead--leegabi-abyss-racing-mobile">
          ...
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--leegabi-abyss-racing-mobile">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--leegabi-abyss-racing-mobile`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      {/* Feature Section 1 */}
      <section className="work-detail__section work-detail__feature work-detail__feature--leegabi-abyss-racing-mobile">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--leegabi-abyss-racing-mobile">
          <img
            src={leegabiWork2_02}
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--leegabi-abyss-racing-mobile">
        <li className="work-detail__feature-row work-detail__feature-row--leegabi-abyss-racing-mobile">
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--leegabi-abyss-racing-mobile">
        <li className="work-detail__card work-detail__card--leegabi-abyss-racing-mobile">
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--leegabi-abyss-racing-mobile">
        <li className="work-detail__bento-card work-detail__bento-card--leegabi-abyss-racing-mobile">
...
export default LeeGabiAbyssRacingMobile;
