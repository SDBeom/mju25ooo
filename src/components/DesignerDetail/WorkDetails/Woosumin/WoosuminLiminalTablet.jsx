...
import '../../styles/works/WoosuminLiminal/WoosuminLiminalTablet.css';

const DEFAULT_FOOTER_TEXT = '새로운 감각의 리미널 가이드에 지속적으로';

const WoosuminLiminalTablet = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }
  ...
  return (
    <div className="work-detail work-detail--woosumin-liminal-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--woosumin-liminal-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--woosumin-liminal-tablet">
          ...
          {work.thumbnail && (
            <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--woosumin-liminal-tablet">
              <img 
                src={work.thumbnail} 
...
export default WoosuminLiminalTablet;
