...
import '../../styles/works/WoosuminSasindo/WoosuminSasindoTablet.css';
...
const WoosuminSasindoTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--woosumin-sasindo-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--woosumin-sasindo-tablet">
            ...
            <div className="work-detail__ctas work-detail__ctas--woosumin-sasindo-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--woosumin-sasindo-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--woosumin-sasindo-tablet">
          <img
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--woosumin-sasindo-tablet">
...
뒷면 QR을 통해 사신도 정보 확인 가능`}</p>
      ...
      {/* Feature Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--info work-detail__feature--woosumin-sasindo-tablet">
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--woosumin-sasindo-tablet">
        <li className="work-detail__card work-detail__card--woosumin-sasindo-tablet">
      ...
      {/* Text Section */}
      <section className="work-detail__section work-detail__text work-detail__text--woosumin-sasindo-tablet">
...
export default WoosuminSasindoTablet;
