...
const WoosuminPierreHuygheTablet = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--woosumin-pierre-huyghe-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--woosumin-pierre-huyghe-tablet">
            ...
            <div className="work-detail__ctas work-detail__ctas--woosumin-pierre-huyghe-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--woosumin-pierre-huyghe-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--woosumin-pierre-huyghe-tablet">
          <img
      ...
      {/* Feature Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--woosumin-pierre-huyghe-tablet">
      ...
      {/* Pull Quote Section */}
      <section className="work-detail__section work-detail__quote work-detail__quote--woosumin-pierre-huyghe-tablet">
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--woosumin-pierre-huyghe-tablet">
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--feature work-detail__cards--woosumin-pierre-huyghe-tablet">
        <li className="work-detail__card work-detail__card--feature work-detail__card--woosumin-pierre-huyghe-tablet">
      ...
      <section className="work-detail__section work-detail__testimonial work-detail__testimonial--woosumin-pierre-huyghe-tablet">
...
export default WoosuminPierreHuygheTablet;
