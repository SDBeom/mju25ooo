...
import '../../styles/works/WoosuminSasindo/WoosuminSasindoDesktop.css';

// 이미지 임포트
import woosuminWork1_01 from '../../../../assets/우수민/woosumin_multimedia_work1_01.webp';
...
/**
 * 우수민 - 사신도 (작품1) Desktop 버전
 * Figma 디자인 기반 구현 (1280px)
 */
const WoosuminSasindoDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--woosumin-sasindo-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--woosumin-sasindo-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--woosumin-sasindo-desktop">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--woosumin-sasindo-desktop">사신도</h2>
            <div className="work-detail__lead work-detail__lead--woosumin-sasindo-desktop">
              <p>{`고분벽화 속 사신도를 현대적으로 재해석해 동서남북을 수호하는 신수의 상징성을 인물과 결합한 작품이다. 전통적 요소를 현대 조형 언어로 조화롭게 풀어냈다.`}</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--woosumin-sasindo-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--woosumin-sasindo-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--woosumin-sasindo-desktop">
          <img
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--woosumin-sasindo-desktop">
...
뒷면 QR을 통해 사신도 정보 확인 가능`}</p>
      ...
      {/* Feature Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--info work-detail__feature--woosumin-sasindo-desktop">
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--woosumin-sasindo-desktop">
        <li className="work-detail__card work-detail__card--woosumin-sasindo-desktop">
        ...
        <li className="work-detail__card work-detail__card--woosumin-sasindo-desktop">
          ...
          <div className="work-detail__card-text">
            ...
            <p className="work-detail__card-description">남쪽, 불을 다룰 수 있는 사신으로 활력있고 장난스러운 남자 아이 외형의 캐릭터 디자인</p>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--woosumin-sasindo-desktop">
          <div className="work-detail__card-image-wrapper">
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--woosumin-sasindo-desktop">
      ...
      {/* Text Section */}
      <section className="work-detail__section work-detail__text work-detail__text--woosumin-sasindo-desktop">
...
export default WoosuminSasindoDesktop;
