...
const WoosuminLiminalMobile = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }
  ...
  return (
    <div className="work-detail work-detail--woosumin-liminal-mobile">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--woosumin-liminal-mobile">
        <div className="work-detail__hero-content work-detail__hero-content--woosumin-liminal-mobile">
          ...
          {work.thumbnail && (
            <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--woosumin-liminal-mobile">
              <img 
                src={work.thumbnail} 
