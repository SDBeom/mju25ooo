...
const JeongitaeDolorSagaTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--jeongitae-dolor-saga-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--jeongitae-dolor-saga-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--jeongitae-dolor-saga-tablet">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--jeongitae-dolor-saga-tablet">
              Dolor Saga
            </h2>
...
인류 대항군의 스토리를 담은 아트북.`}
          ...
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--jeongitae-dolor-saga-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--jeongitae-dolor-saga-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--jeongitae-dolor-saga-tablet">
          <img
      ...
      {/* Feature Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--jeongitae-dolor-saga-tablet">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--jeongitae-dolor-saga-tablet">
          <img
...
그들의 힘은 일반적인 존재인 인간, 엘프, 드워프보다 훨씬 월등하다.`}
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--jeongitae-dolor-saga-tablet work-detail__cards--bento">
        <li className="work-detail__card work-detail__card--jeongitae-dolor-saga-tablet work-detail__card--bento-1">
...
인류는 처절하게 싸우지만 그들의 목숨을 비웃듯 용들의 브레스는 멈추지 않는다.`}
      ...
      <section className="work-detail__section work-detail__feature-cards work-detail__feature-cards--jeongitae-dolor-saga-tablet">
...
export default JeongitaeDolorSagaTablet;
