...
const JeongitaeWarOrbTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--jeongitae-warorb-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--jeongitae-warorb-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--jeongitae-warorb-tablet">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--jeongitae-warorb-tablet">
              War Orb
            </h2>
...
소개하는 영상물이다.`}
          ...
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--jeongitae-warorb-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--jeongitae-warorb-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--jeongitae-warorb-tablet">
          <img
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--jeongitae-warorb-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--jeongitae-warorb-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--jeongitae-warorb-tablet"
          />
        </div>
      </section>

      {/* Feature Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--jeongitae-warorb-tablet">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--jeongitae-warorb-tablet">
          <img
...
이 오브는 그것을 취한 자들에게 원하는 힘을 하사한다.`}
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--jeongitae-warorb-tablet work-detail__cards--bento">
        <li className="work-detail__card work-detail__card--jeongitae-warorb-tablet work-detail__card--bento-1">
...
export default JeongitaeWarOrbTablet;
