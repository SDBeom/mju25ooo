...
const JeongitaeWarOrbDesktop = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--jeongitae-warorb-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--jeongitae-warorb-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--jeongitae-warorb-desktop">
            ...
            <div className="work-detail__ctas work-detail__ctas--jeongitae-warorb-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--jeongitae-warorb-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--jeongitae-warorb-desktop">
          <img
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--jeongitae-warorb-desktop work-detail__cards--bento">
        <li className="work-detail__card work-detail__card--jeongitae-warorb-desktop work-detail__card--bento-1">
        ...
        <li className="work-detail__card work-detail__card--jeongitae-warorb-desktop work-detail__card--bento-3">
          <div className="work-detail__card-image-wrapper">
            <img
...
export default JeongitaeWarOrbDesktop;
