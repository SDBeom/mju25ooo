 ...
 */
const JeongitaeDolorSagaDesktop = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }
    ...
    <div className="work-detail work-detail--jeongitae-dolor-saga-desktop">
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--jeongitae-dolor-saga-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--jeongitae-dolor-saga-desktop">
          <div className="work-detail__text-group">
            ...
            <div className="work-detail__lead work-detail__lead--jeongitae-dolor-saga-desktop">
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--jeongitae-dolor-saga-desktop">
        ...
        <div className="work-detail__feature-text">
          ...
          <p className="mb-0">돌로르사가 속 등장하는 용은 자신들의 발 아래 땅을 지배하기 위해 파괴를 일삼는 종족으로 묘사된다.</p>
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--jeongitae-dolor-saga-desktop work-detail__cards--bento">
        ...
        <li className="work-detail__card work-detail__card--jeongitae-dolor-saga-desktop work-detail__card--bento-2">
          ...
          <div className="work-detail__card-text">
            ...
            <p className="mb-0">이들은 자신의 목숨을 바쳐 자신들의 고향과 가족, 사랑하는 이들이</p>
            <p>살아가는 이 세상을 지키기위해 싸운다.</p>
          </div>
        </li>
