...
import '../../styles/works/SeoRinRavenX/SeoRinRavenXDesktop.css';
...
/**
 * 전서린 - RAVEN-X (작품1) Desktop 버전
 * Figma 디자인 기반 구현 (1280px)
 */
const SeoRinRavenXDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--seorin-ravenx-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--seorin-ravenx-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--seorin-ravenx-desktop">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--seorin-ravenx-desktop">
              RAVEN-X
            </h2>
            <p className="work-detail__lead work-detail__lead--seorin-ravenx-desktop">
              매끄러운 곡선 속 숨은 날카로운 실루엣, RAVEN-X는 까마귀 형상으로 디자인된 미래 전투기이다.
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--seorin-ravenx-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--seorin-ravenx-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--seorin-ravenx-desktop">
          <img
            src={seoRinWork1_01}
            alt="RAVEN-X"
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--seorin-ravenx-desktop">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--seorin-ravenx-desktop">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--seorin-ravenx-desktop"
          />
        </div>
      </section>

      {/* Text Section */}
      <section className="work-detail__section work-detail__text-section work-detail__text-section--seorin-ravenx-desktop">
        ...
        <div className="work-detail__text-content">
          <p>첨단 기술이 고도로 발전한 시대 RAVEN-X는 내부의 위협과 테러로부터 인간을 수호하는 임무를 수행한다. 강인한 외관 속에 정교하게 설계된 구조는 위협적이면서도 우아한 곡선을 이루며 미래 전투기의 가능성을 직관적으로 느끼게 한다.{'\n\n'}RAVEN-X는 지구의 대기권은 물론 광활한 우주 공간까지 자유롭게 비행할 수 있도록 설계되었다. 각 비행 모드에 따라 자동으로 최적화되는 꼬리 구조는 상황에 맞게 접혀 공기 저항을 최소화하고, 폭발적인 가속력을 발휘한다. 또한 360도 회전이 가능한 엔진 시스템은 전방위 기동을 가능하게 한다. RAVEN-X는 기계적 구조의 완성도와 모션의 리얼리티를 탐구한 작품으로 구조적 설득력과 움직임의 자연스러움을 영상으로 표현한다.</p>
        </div>
      </section>

      {/* Feature Section - RAVEN-X */}
      <section className="work-detail__section work-detail__feature work-detail__feature--seorin-ravenx-desktop">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--seorin-ravenx-desktop">
          <img
            src={seoRinWork1_02}
            alt="RAVEN-X"
        ...
        <div className="work-detail__feature-text">
          ...
          <p>{`이 전투기는 단순한 형태를 넘어 실제로 동작 가능한 구조와 메커니즘을 고려하여 제작되었다. 특히 엔진 회전축의 분할 구조, `}
{`꼬리의 접힘 각도, 동체의 회전 중심 등 기계적 연결 관계를 기반으로 모델링되었으며 실제 작동 원리를 바탕으로 한 자연스러운 움직임을 `}
구현하고자 했다.</p>
        </div>
      </section>

      {/* Feature Cards Section - Main body, Engine Part, Tail Structure */}
      <ul className="work-detail__section work-detail__cards work-detail__cards--seorin-ravenx-desktop">
        <li className="work-detail__card work-detail__card--seorin-ravenx-desktop">
          ...
          <div className="work-detail__card-text">
            ...
            <p>{`RAVEN-X의 실루엣을 보여주는 탑뷰이다.`}
{`매끄럽게 이어지는 곡선과 날카로운 엣지가 `}
{`공존한다.`}</p>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--seorin-ravenx-desktop">
...
{`기술적 완성도를 드러낸다.`}</p>
        ...
        <li className="work-detail__card work-detail__card--seorin-ravenx-desktop">
          ...
          <div className="work-detail__card-text">
            ...
            <p>{`공기 역학적 라인을 따라 설계된 꼬리 구조로, `}
{`고속 비행 중에도 안정적인 밸런스를 유지한다.`}</p>
          </div>
        </li>
      </ul>

      {/* Feature Rows Section - Beauty Render, Wireframe Render */}
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--seorin-ravenx-desktop">
        {/* Row 1 - Beauty Render */}
        <li className="work-detail__feature-row work-detail__feature-row--seorin-ravenx-desktop">
          <div className="work-detail__feature-content">
            <div className="work-detail__feature-text">
              <h4 className="work-detail__feature-title">Beauty Render</h4>
              <p>{`이 이미지는 Autodesk MAYA를 사용하여 텍스처와 라이팅을 적용한 `}
{`RAVEN-X의 최종 렌더이다.`}</p>
            </div>
          </div>
          <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--small">
            <img
              src={seoRinWork1_06}
              alt="Beauty Render"
              className="work-detail__feature-image"
        ...
        <li className="work-detail__feature-row work-detail__feature-row--seorin-ravenx-desktop work-detail__feature-row--reverse">
          <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--small">
            <img
              src={seoRinWork1_07}
          ...
          <div className="work-detail__feature-content">
            <div className="work-detail__feature-text">
              ...
              <p>{`같은 컷을 기준으로 RAVEN-X의 모델링 구조와 폴리곤 디테일을 `}
{`확인할 수 있도록 와이어 프레임으로 렌더한 이미지이다.`}</p>
            </div>
          </div>
        </li>
      </ul>
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--seorin-ravenx-desktop">
      ...
      <section className="work-detail__section work-detail__marquee work-detail__marquee--seorin-ravenx-desktop">
        <h3 className="work-detail__marquee-text">Turntable Renders</h3>
      </section>

      {/* Feature Cards Section - Beauty, Grey, Wireframe (with border) */}
      <ul className="work-detail__section work-detail__cards work-detail__cards--seorin-ravenx-desktop work-detail__cards--bordered">
        <li className="work-detail__card work-detail__card--seorin-ravenx-desktop work-detail__card--bordered">
          <div className="work-detail__card-image-wrapper">
            <img
              src={seoRinWork1_16}
              alt="Beauty"
          ...
          <div className="work-detail__card-text">
            ...
            <p>{`완성된 텍스처와 라이팅을 통해 작품의 `}
{`분위기와 질감을 표현한 뷰티 이미지이다.`}</p>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--seorin-ravenx-desktop work-detail__card--bordered">
          <div className="work-detail__card-image-wrapper">
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--seorin-ravenx-desktop work-detail__cards--bordered">
        ...
        <li className="work-detail__card work-detail__card--seorin-ravenx-desktop work-detail__card--bordered">
          ...
          <div className="work-detail__card-text">
            ...
            <p>{`고속 비행 시에는 꼬리 구조가 접히며 위로`}
{`상승해 공기 저항을 최소화하고 속도를 `}
{`극대화할 수 있는 형태로 전환된다.`}</p>
          </div>
        </li>
      </ul>
    </div>
...
export default SeoRinRavenXDesktop;
