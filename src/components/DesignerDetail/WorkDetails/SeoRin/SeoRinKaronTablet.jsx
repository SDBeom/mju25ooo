...
const SeoRinKaronTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--seorin-karon-tablet">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--seorin-karon-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--seorin-karon-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--seorin-karon-tablet"
          />
        </div>
      </section>
