...
import '../../styles/works/KimChaeYoungCyberJesasang/KimChaeYoungCyberJesasangTablet.css';
...
/**
 * 김채영 - 사이버 제사상 Tablet 버전
 * Figma 디자인 기반 구현 (800px)
 */
const KimChaeYoungCyberJesasangTablet = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--kim-chae-young-cyber-jesasang-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-chae-young-cyber-jesasang-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--kim-chae-young-cyber-jesasang-tablet">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--kim-chae-young-cyber-jesasang-tablet">사이버 제사상</h2>
            <p className="work-detail__lead work-detail__lead--kim-chae-young-cyber-jesasang-tablet">
              없애고 싶은 감정을 디지털 제물로 시각화해 떠나보내는 1인 참여형 인터랙션 작품
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--kim-chae-young-cyber-jesasang-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--kim-chae-young-cyber-jesasang-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--kim-chae-young-cyber-jesasang-tablet">
          <img
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--kim-chae-young-cyber-jesasang-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--kim-chae-young-cyber-jesasang-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--kim-chae-young-cyber-jesasang-tablet"
          />
        </div>
      </section>

      {/* Text Section */}
      <section className="work-detail__section work-detail__text-section work-detail__text-section--kim-chae-young-cyber-jesasang-tablet">
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--kim-chae-young-cyber-jesasang-tablet">
      ...
      <section className="work-detail__section work-detail__feature-row work-detail__feature-row--kim-chae-young-cyber-jesasang-tablet">
      ...
      <ul className="work-detail__section work-detail__feature-list work-detail__feature-list--kim-chae-young-cyber-jesasang-tablet">
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--kim-chae-young-cyber-jesasang-tablet">
...
export default KimChaeYoungCyberJesasangTablet;
