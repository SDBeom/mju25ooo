...
const KimChaeYoungCyberJesasangMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--kim-chae-young-cyber-jesasang-mobile">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--kim-chae-young-cyber-jesasang-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--kim-chae-young-cyber-jesasang-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--kim-chae-young-cyber-jesasang-mobile"
          />
        </div>
      </section>
