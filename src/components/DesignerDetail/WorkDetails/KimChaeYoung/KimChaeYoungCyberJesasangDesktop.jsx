 ...
 */
const KimChaeYoungCyberJesasangDesktop = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }
  ...
  return (
    <div className="work-detail work-detail--kim-chae-young-cyber-jesasang-desktop">
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-chae-young-cyber-jesasang-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--kim-chae-young-cyber-jesasang-desktop">
          <div className="work-detail__text-group">
            ...
            <div className="work-detail__lead work-detail__lead--kim-chae-young-cyber-jesasang-desktop">
      ...
      <ul className="work-detail__section work-detail__feature-list work-detail__feature-list--kim-chae-young-cyber-jesasang-desktop">
