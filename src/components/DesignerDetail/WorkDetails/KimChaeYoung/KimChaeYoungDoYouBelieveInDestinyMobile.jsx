...
import '../../styles/works/KimChaeYoungDoYouBelieveInDestiny/KimChaeYoungDoYouBelieveInDestinyMobile.css';
...
const KimChaeYoungDoYouBelieveInDestinyMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--kim-chae-young-do-you-believe-in-destiny-mobile">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-chae-young-do-you-believe-in-destiny-mobile">
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--kim-chae-young-do-you-believe-in-destiny-mobile">
          <img
        ...
        <div className="work-detail__hero-content work-detail__hero-content--kim-chae-young-do-you-believe-in-destiny-mobile">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--kim-chae-young-do-you-believe-in-destiny-mobile">운명을 믿으세요</h2>
            <div className="work-detail__lead work-detail__lead--kim-chae-young-do-you-believe-in-destiny-mobile">
              <p>운명과 선택 그리고 인생에 대한 보드게임</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--kim-chae-young-do-you-believe-in-destiny-mobile">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--kim-chae-young-do-you-believe-in-destiny-mobile`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--kim-chae-young-do-you-believe-in-destiny-mobile">
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--kim-chae-young-do-you-believe-in-destiny-mobile">
        ...
        <li className="work-detail__feature-card">
          <div className="work-detail__feature-card-image-wrapper">
            <img
              ...
              alt="이기 카드"
              className="work-detail__feature-card-image"
              onError={(e) => handleImageError(e, kimChaeYoungWork1_04, work.id, 'card-egoism')}
              loading="lazy"
            />
          </div>
          <div className="work-detail__feature-card-text">
        ...
        <li className="work-detail__feature-card">
          <div className="work-detail__feature-card-image-wrapper">
            <img
              ...
              alt="안정 카드"
              className="work-detail__feature-card-image"
              onError={(e) => handleImageError(e, kimChaeYoungWork1_05, work.id, 'card-stability')}
              loading="lazy"
            />
          </div>
          <div className="work-detail__feature-card-text">
        ...
        <li className="work-detail__feature-card">
          <div className="work-detail__feature-card-image-wrapper">
            <img
              ...
              alt="모험 카드"
              className="work-detail__feature-card-image"
              onError={(e) => handleImageError(e, kimChaeYoungWork1_06, work.id, 'card-adventure')}
              loading="lazy"
            />
          </div>
          <div className="work-detail__feature-card-text">
        ...
        <li className="work-detail__feature-card">
          <div className="work-detail__feature-card-image-wrapper">
            <img
              ...
              alt="인내 카드"
              className="work-detail__feature-card-image"
              onError={(e) => handleImageError(e, kimChaeYoungWork1_07, work.id, 'card-patience')}
              loading="lazy"
            />
          </div>
          <div className="work-detail__feature-card-text">
      ...
      {/* Feature Centered - Question Card */}
      <section className="work-detail__section work-detail__feature-centered work-detail__feature-centered--kim-chae-young-do-you-believe-in-destiny-mobile">
        <div className="work-detail__feature-image-wrapper">
          <img
      ...
      {/* Feature Centered - Destiny Sheet */}
      <section className="work-detail__section work-detail__feature-centered work-detail__feature-centered--kim-chae-young-do-you-believe-in-destiny-mobile">
        <div className="work-detail__feature-image-wrapper">
          <img
...
export default KimChaeYoungDoYouBelieveInDestinyMobile;
