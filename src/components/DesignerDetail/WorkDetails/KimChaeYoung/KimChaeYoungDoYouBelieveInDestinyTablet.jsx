...
import '../../styles/works/KimChaeYoungDoYouBelieveInDestiny/KimChaeYoungDoYouBelieveInDestinyTablet.css';
...
/**
 * 김채영 - 운명을 믿으세요 Tablet 버전
 * Figma 디자인 기반 구현 (800px)
 */
const KimChaeYoungDoYouBelieveInDestinyTablet = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--kim-chae-young-do-you-believe-in-destiny-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-chae-young-do-you-believe-in-destiny-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--kim-chae-young-do-you-believe-in-destiny-tablet">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--kim-chae-young-do-you-believe-in-destiny-tablet">운명을 믿으세요?</h2>
            <p className="work-detail__lead work-detail__lead--kim-chae-young-do-you-believe-in-destiny-tablet">
              운명과 선택 그리고 인생에 대한 보드게임
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--kim-chae-young-do-you-believe-in-destiny-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--kim-chae-young-do-you-believe-in-destiny-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--kim-chae-young-do-you-believe-in-destiny-tablet">
          <img
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--kim-chae-young-do-you-believe-in-destiny-tablet">
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--kim-chae-young-do-you-believe-in-destiny-tablet">
        <li className="work-detail__feature-card">
          ...
          <div className="work-detail__feature-card-text">
            ...
            <p className="work-detail__feature-card-description">
              붉은색과 분홍색 선이 여러 겹으로 교차하며 외부로 뻗어 나가는 확산형 구조를 가진다. 선들이 중심보다는 주변으로 향하며 서로 얽히는 형태는, 개인보다 타인에게 향하는 관계적 에너지를 시각적으로 표현한다.
            </p>
          </div>
        </li>
        <li className="work-detail__feature-card">
          ...
          <div className="work-detail__feature-card-text">
            ...
            <p className="work-detail__feature-card-description">
              굵은 붉은 선들이 일정한 간격으로 반복되어 격자형 구조를 만든다. 형태가 균일하고 밀도가 높아 시각적으로 무게감과 질서를 준다.
            </p>
          </div>
        </li>
        <li className="work-detail__feature-card">
          ...
          <div className="work-detail__feature-card-text">
            ...
            <p className="work-detail__feature-card-description">
              형광 초록과 보라색 선이 대칭적인 축을 중심으로 얽혀 있으며, 하단에서 상단으로 단단히 세워진 구조를 가진다. 형태가 수직적으로 세워져 있어 '지속'과 '견딤'을 연상시킨다.
            </p>
          </div>
        </li>
      </ul>
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--kim-chae-young-do-you-believe-in-destiny-tablet">
        <li className="work-detail__feature-card">
          ...
          <div className="work-detail__feature-card-text">
            ...
            <p className="work-detail__feature-card-description">
              노란색과 주황색 선이 원형으로 반복 회전하며 중심을 강조한다. 강한 색 대비와 회전형 구조가 자기 중심적인 에너지와 팽창된 힘을 시각화한다.
            </p>
          </div>
        </li>
        <li className="work-detail__feature-card">
          ...
          <div className="work-detail__feature-card-text">
            ...
            <p className="work-detail__feature-card-description">
              푸른 회색 선이 불규칙한 궤적을 따라 흩어지며 복잡한 공간감을 형성한다. 형태의 예측 불가능성과 열린 구조가 실험과 탐색의 이미지를 만든다.
            </p>
          </div>
        </li>
        <li className="work-detail__feature-card">
          ...
          <div className="work-detail__feature-card-text">
            ...
            <p className="work-detail__feature-card-description">
              청록과 파란색 선이 부드럽게 휘어지며 느슨하게 얽혀 있다. 형태가 유동적이고 규칙이 약해 시각적으로 자유롭고 감각적인 인상을 준다.
            </p>
          </div>
        </li>
      </ul>
      ...
      <section className="work-detail__section work-detail__feature-row work-detail__feature-row--kim-chae-young-do-you-believe-in-destiny-tablet">
        ...
        <div className="work-detail__feature-row-content">
          ...
          <p className="work-detail__feature-description">
            총 90장으로 이루어져 있으며 각각의 속성쌍과 대응한다. 게임의 가장 큰 진행을 도와준다.
          </p>
        </div>
      </section>
      ...
      <section className="work-detail__section work-detail__feature-row work-detail__feature-row--kim-chae-young-do-you-believe-in-destiny-tablet">
        ...
        <div className="work-detail__feature-row-content">
          ...
          <p className="work-detail__feature-description">
            게임의 경쟁 속성에 속하는 카드. 프로젝트의 주제를 극대화 할 수 있는 장치로 쓰인다.
          </p>
        </div>
      </section>
      ...
      <section className="work-detail__section work-detail__feature-row work-detail__feature-row--kim-chae-young-do-you-believe-in-destiny-tablet">
        ...
        <div className="work-detail__feature-row-content">
          ...
          <p className="work-detail__feature-description">
            주사위를 통해 결정되며, 게임의 주요 포인트 중 하나이다.
          </p>
        </div>
      </section>
      ...
      <section className="work-detail__section work-detail__feature-row work-detail__feature-row--kim-chae-young-do-you-believe-in-destiny-tablet">
        ...
        <div className="work-detail__feature-row-content">
          ...
          <p className="work-detail__feature-description">
            검은 점과 얇은 선으로 이루어진 네트워크는 '인생의 선택'과 그로 인한 '결과의 연결'을 시각화한 구조이다. 각 점은 하나의 선택, 혹은 개인의 결정 순간을 의미하며, 선은 그 선택들이 이어지며 만들어내는 인과의 흐름을 나타낸다. 배경에 겹쳐진 반복적인 곡선 형태는 삶의 복잡성과 예측 불가능성을 표현한다. 이 곡선 위에서 점들이 규칙적으로 배치되지 않은 이유는, 인생의 선택이 결코 단일한 방향으로 이어지지 않음을 드러내기 위함이다.
          </p>
        </div>
      </section>
    </div>
...
export default KimChaeYoungDoYouBelieveInDestinyTablet;
