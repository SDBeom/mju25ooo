...
import heoJiHoonWork1_19 from '../../../../assets/허지훈/허지훈_모션디자인_작품1_19.png';
...
const HeoJihoonMasterImaginationDesktop = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--heo-jihoon-master-imagination-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--master-imagination-desktop">
...
alt="창작�구, 마우스"
        ...
        <div className="work-detail__feature-row">
          <div className="work-detail__feature-row-image-wrapper">
            <img 
              ...
              className="work-detail__feature-row-image"
              onError={(e) => handleImageError(e, heoJiHoonWork1_07, work.id, 'row-2')}
              loading="lazy"
            />
          </div>
          <div className="work-detail__feature-row-content">
      ...
      <section className="work-detail__section work-detail__cards work-detail__cards--desktop work-detail__cards--final">
        <div className="work-detail__card">
          <div className="work-detail__card-image-wrapper">
            <img 
