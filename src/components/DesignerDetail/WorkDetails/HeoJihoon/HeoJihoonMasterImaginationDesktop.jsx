...
const HeoJihoonMasterImaginationDesktop = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--heo-jihoon-master-imagination-desktop">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--heo-jihoon-master-imagination-desktop">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--heo-jihoon-master-imagination-desktop">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/FKUY2V-2BRA?si=nPL95-gXoUbt373m&controls=0"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerPolicy="strict-origin-when-cross-origin"
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--heo-jihoon-master-imagination-desktop"
          />
        </div>
      </section>
