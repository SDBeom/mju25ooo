...
/**
 * 허지훈 - Eternal Vision (작품2) Mobile 버전
 * Figma 디자인 기반 구현
 */
const HeoJihoonEternalVisionMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--heo-jihoon-eternal-vision-mobile">
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--eternal-vision-mobile">
        ...
        <div className="work-detail__hero-content work-detail__hero-content--mobile">
          <div className="work-detail__text-group">
            ...
            <p className="work-detail__lead work-detail__lead--mobile">{work.summary || '현대자동차의 상징적 모델 \'포니 쿠페\'의 유산과 이를 계승한 \'N74\'의 탄생을 감각적으로 담은 시네마틱 브랜딩 영상.'}</p>
          </div>
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--eternal-vision-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--eternal-vision-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--eternal-vision-mobile"
          />
        </div>
      </section>
