...
/**
 * 허지훈 - Eternal Vision (작품2) Tablet 버전
 * Figma 디자인 기반 구현 (800px)
 */
const HeoJihoonEternalVisionTablet = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--heo-jihoon-eternal-vision-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--eternal-vision-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--tablet">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--tablet">{work.title || 'Eternal Vision'}</h2>
            <p className="work-detail__lead work-detail__lead--tablet">{work.summary || '현대자동차의 상징적 모델 \'포니 쿠페\'의 유산과 이를 계승한 \'N74\'의 탄생을 감각적으로 담은 시네마틱 브랜딩 영상.'}</p>
          </div>
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--eternal-vision-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--eternal-vision-tablet">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/nIQBC2fkFM8?si=PnPmNr8Vq8rwO4Lf&controls=0"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerPolicy="strict-origin-when-cross-origin"
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--eternal-vision-tablet"
          />
        </div>
      </section>
...
export default HeoJihoonEternalVisionTablet;
