 ...
 */
const HeoJihoonEternalVisionTablet = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--eternal-vision-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--tablet">
          <div className="work-detail__text-group">
            ...
            <p className="work-detail__lead work-detail__lead--tablet">{work.summary || '현대자동차의 상징적인 모델 \'포니 쿠페\'의 산물을 계승한 \'N Vision 74\'의 생생한 감각으로 풀어낸 시네마틱 브랜딩 영상.'}</p>
          </div>
