...
/**
 * 허지훈 - Master your Imagination (작품1) Mobile 버전
...
const HeoJihoonMasterImaginationMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--heo-jihoon-master-imagination-mobile">
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--master-imagination-mobile">
        ...
        <div className="work-detail__hero-content work-detail__hero-content--mobile">
          <div className="work-detail__text-group">
            ...
            <p className="work-detail__lead work-detail__lead--mobile">{work.summary || 'MX Master 3S를 통해 당신의 상상을 현실로 이끌어내라는 메시지를 담은 시네마틱 브랜딩 영상.'}</p>
          </div>
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--heo-jihoon-master-imagination-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--heo-jihoon-master-imagination-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--heo-jihoon-master-imagination-mobile"
          />
        </div>
      </section>
      ...
      <section className="work-detail__section work-detail__text-section work-detail__text-section--mobile">
        <div className="work-detail__text-headline">
          ...
          <h3 className="work-detail__subtitle">마우스를 창작<br />도구로서 바라보다</h3>
        </div>
