...
const HeoJihoonMasterImaginationTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--heo-jihoon-master-imagination-tablet">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--heo-jihoon-master-imagination-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--heo-jihoon-master-imagination-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--heo-jihoon-master-imagination-tablet"
          />
        </div>
      </section>
