...
import '../../styles/works/ParkJinaCrossCooty/ParkJinaCrossCootyMobile.css';
...
const ParkJinaCrossCootyMobile = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--park-jina-cross-cooty-mobile">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--park-jina-cross-cooty-mobile">
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--park-jina-cross-cooty-mobile">
          <img
        ...
        <div className="work-detail__hero-content work-detail__hero-content--park-jina-cross-cooty-mobile">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--park-jina-cross-cooty-mobile">Cross Cooty</h2>
            <div className="work-detail__lead work-detail__lead--park-jina-cross-cooty-mobile">
              <p>"Share a moment, share a Cooty!"</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--park-jina-cross-cooty-mobile">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--park-jina-cross-cooty-mobile`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      <section className="work-detail__section work-detail__text-section work-detail__text-section--park-jina-cross-cooty-mobile">
        <div className="work-detail__text-headline">
          <h3 className="work-detail__subtitle work-detail__subtitle--park-jina-cross-cooty-mobile">Cooty Universe</h3>
        </div>
        <div className="work-detail__text-content work-detail__text-content--park-jina-cross-cooty-mobile">
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--park-jina-cross-cooty-mobile">
        <li className="work-detail__bento-card work-detail__bento-card--park-jina-cross-cooty-mobile">
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--park-jina-cross-cooty-mobile">
        <li className="work-detail__feature-card work-detail__feature-card--park-jina-cross-cooty-mobile">
          ...
          <div className="work-detail__feature-card-text">
            <h5 className="work-detail__feature-card-title">Cotton</h5>
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--park-jina-cross-cooty-mobile">
        <li className="work-detail__feature-row work-detail__feature-row--park-jina-cross-cooty-mobile">
          ...
          <div className="work-detail__feature-row-content">
            <h4 className="work-detail__feature-row-title">COTONA</h4>
      ...
      {/* Feature Row: Ice */}
      <section className="work-detail__section work-detail__feature-row-single work-detail__feature-row-single--park-jina-cross-cooty-mobile">
        <div className="work-detail__feature-row-image-wrapper">
          <img
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards-character work-detail__feature-cards-character--park-jina-cross-cooty-mobile">
        <li className="work-detail__feature-card-character work-detail__feature-card-character--park-jina-cross-cooty-mobile">
      ...
      {/* Marquee (empty) */}
      <section className="work-detail__section work-detail__marquee work-detail__marquee--park-jina-cross-cooty-mobile">
        {/* Empty marquee section */}
      </section>

      {/* Feature Bento: Full Width Image */}
      <ul className="work-detail__section work-detail__bento work-detail__bento--park-jina-cross-cooty-mobile">
        <li className="work-detail__bento-card work-detail__bento-card-full work-detail__bento-card-full--park-jina-cross-cooty-mobile">
          <div className="work-detail__bento-image-wrapper">
            <img
...
export default ParkJinaCrossCootyMobile;
