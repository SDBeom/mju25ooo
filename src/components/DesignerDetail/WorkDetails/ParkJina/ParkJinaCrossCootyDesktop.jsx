...
import '../../styles/works/ParkJinaCrossCooty/ParkJinaCrossCootyDesktop.css';
...
/**
 * 박진아 - Cross Cooty Desktop 버전
 * Figma 디자인 기반 구현 (1280px)
 */
const ParkJinaCrossCootyDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--park-jina-cross-cooty-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--park-jina-cross-cooty-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--park-jina-cross-cooty-desktop">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--park-jina-cross-cooty-desktop">Cross Cooty</h2>
            <p className="work-detail__lead work-detail__lead--park-jina-cross-cooty-desktop">"Share a moment, share a Cooty!"</p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--park-jina-cross-cooty-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--park-jina-cross-cooty-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--park-jina-cross-cooty-desktop">
          <img
      ...
      <section className="work-detail__section work-detail__text-section work-detail__text-section--park-jina-cross-cooty-desktop">
        <div className="work-detail__text-headline">
          <h3 className="work-detail__subtitle work-detail__subtitle--park-jina-cross-cooty-desktop">Cooty Universe</h3>
        </div>
        <p className="work-detail__text-content work-detail__text-content--park-jina-cross-cooty-desktop">
...
그리고 독특한 생물종으로 구성된 하나의 작은 세계를 이룬다. 
 ...
 Cooty Universe는 이러한 생명체와 공간들이 유기적으로 연결되며, 현실과 상상의 경계를 확장해 나가는 브랜드 세계이다.`}
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--park-jina-cross-cooty-desktop">
        <li className="work-detail__bento-card work-detail__bento-card--park-jina-cross-cooty-desktop">
...
단어 자체가 살아 움직이는 듯한 인상을 의도했다.
 부드러운 곡선과 따뜻한 컬러 조합은 브랜드의 친근하고 감각적인 세계관을 완성한다.`}
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--park-jina-cross-cooty-desktop">
        <li className="work-detail__feature-card work-detail__feature-card--park-jina-cross-cooty-desktop">
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--park-jina-cross-cooty-desktop">
        <li className="work-detail__feature-row work-detail__feature-row--park-jina-cross-cooty-desktop">
        ...
        <li className="work-detail__feature-row work-detail__feature-row--park-jina-cross-cooty-desktop work-detail__feature-row--reverse">
          <div className="work-detail__feature-row-content">
            <div className="work-detail__feature-row-text">
...
차가운 공기 속에서 생명이 반짝이는 곳.`}
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards-character work-detail__feature-cards-character--park-jina-cross-cooty-desktop">
        <li className="work-detail__feature-card-character work-detail__feature-card-character--park-jina-cross-cooty-desktop">
...
주변환경과 비슷하게 몸과 날개의 색상을 바꿀 수 있다.`}
      ...
      {/* Marquee */}
      <section className="work-detail__section work-detail__marquee work-detail__marquee--park-jina-cross-cooty-desktop">
        <h3 className="work-detail__marquee-text">Share a moment, Share a Cotty!</h3>
      </section>

      {/* Feature Bento: Full Width Image */}
      <ul className="work-detail__section work-detail__bento work-detail__bento--park-jina-cross-cooty-desktop">
        <li className="work-detail__bento-card work-detail__bento-card-full work-detail__bento-card-full--park-jina-cross-cooty-desktop">
          <div className="work-detail__bento-image-wrapper">
            <img
...
export default ParkJinaCrossCootyDesktop;
