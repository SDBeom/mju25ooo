 ...
 */
const ParkJinaRemainDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--park-jina-remain-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--park-jina-remain-desktop">
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--park-jina-remain-desktop">
          <img
        ...
        <div className="work-detail__hero-content work-detail__hero-content--park-jina-remain-desktop">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--park-jina-remain-desktop">REMAIN</h2>
            <p className="work-detail__lead work-detail__lead--park-jina-remain-desktop">
              {`Even Without holding on, 
I still REMAIN`}
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--park-jina-remain-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--park-jina-remain-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--park-jina-remain-desktop">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--park-jina-remain-desktop">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--park-jina-remain-desktop"
          />
        </div>
      </section>

      {/* Feature 3 */}
      <section className="work-detail__section work-detail__feature work-detail__feature--park-jina-remain-desktop">
...
조용히 남아있을 뿐이다.`}
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--park-jina-remain-desktop">
        <li className="work-detail__feature-card work-detail__feature-card--park-jina-remain-desktop">
...
존재의 잔향은 남는다.`}
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--park-jina-remain-desktop">
        <li className="work-detail__feature-row work-detail__feature-row--park-jina-remain-desktop">
...
존재 자신이다.`}
        ...
        <li className="work-detail__feature-row work-detail__feature-row--park-jina-remain-desktop work-detail__feature-row--reverse">
          <div className="work-detail__feature-row-content">
            <div className="work-detail__feature-row-text">
...
함께 흔들리는 것은 결국 나의 중심이다.`}
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--park-jina-remain-desktop">
        <li className="work-detail__bento-card work-detail__bento-card--park-jina-remain-desktop work-detail__bento-card--full">
...
나'는 가장 쉽게 무너진다.`}
      ...
      {/* Marquee 1 */}
      <section className="work-detail__section work-detail__marquee work-detail__marquee--park-jina-remain-desktop">
        <h3 className="work-detail__marquee-text">The Path of Places.</h3>
      </section>
...
export default ParkJinaRemainDesktop;
