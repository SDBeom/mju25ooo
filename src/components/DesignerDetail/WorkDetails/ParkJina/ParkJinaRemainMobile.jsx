...
const ParkJinaRemainMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--park-jina-remain-mobile">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--park-jina-remain-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--park-jina-remain-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--park-jina-remain-mobile"
          />
        </div>
      </section>
