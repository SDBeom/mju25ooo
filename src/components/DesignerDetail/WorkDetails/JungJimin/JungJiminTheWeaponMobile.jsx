...
const JungJiminTheWeaponMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--jungjimin-the-weapon-mobile">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--jungjimin-weapon-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--jungjimin-weapon-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--jungjimin-weapon-mobile"
          />
        </div>
      </section>
