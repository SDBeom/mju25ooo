...
import '../../styles/works/JungJiminTheWeapon/JungJiminTheWeaponDesktop.css';
...
/**
 * 정지민 - The Weapon (작품2) Desktop 버전
 * Figma 디자인 기반 구현 (1280px)
 */
const JungJiminTheWeaponDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--jungjimin-the-weapon-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--jungjimin-weapon-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--jungjimin-weapon-desktop">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--jungjimin-weapon-desktop">
              {work.title || 'The weapon'}
            </h2>
            <p className="work-detail__lead work-detail__lead--jungjimin-weapon-desktop">
              {work.summary || '무기 모델링'}
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--jungjimin-weapon-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--jungjimin-weapon-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--jungjimin-weapon-desktop">
          <img
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--jungjimin-weapon-desktop">
        ...
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--jungjimin-weapon-desktop">
          <img
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--jungjimin-weapon-desktop">
        {/* Row 1 - 해머 */}
        <li className="work-detail__feature-row work-detail__feature-row--jungjimin-weapon-desktop">
          <div className="work-detail__feature-content work-detail__feature-content--jungjimin-weapon-desktop">
            <div className="work-detail__feature-text">
        ...
        {/* Row 2 - 대검 (reverse) */}
        <li className="work-detail__feature-row work-detail__feature-row--jungjimin-weapon-desktop work-detail__feature-row--reverse">
          <div className="work-detail__feature-content work-detail__feature-content--jungjimin-weapon-desktop">
            <div className="work-detail__feature-text">
      ...
      {/* Feature Section 3 - 단검 */}
      <section className="work-detail__section work-detail__feature work-detail__feature--jungjimin-weapon-desktop work-detail__feature--image-top">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--jungjimin-weapon-desktop work-detail__feature-image-wrapper--large">
          <img
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--jungjimin-weapon-desktop">
        <li className="work-detail__card work-detail__card--jungjimin-weapon-desktop">
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--jungjimin-weapon-desktop">
        <li className="work-detail__bento-card work-detail__bento-card--jungjimin-weapon-1">
        ...
        <li className="work-detail__bento-card work-detail__bento-card--jungjimin-weapon-2">
          <div className="work-detail__bento-card-image-wrapper">
            <img
        ...
        <li className="work-detail__bento-card work-detail__bento-card--jungjimin-weapon-3">
          <div className="work-detail__bento-card-image-wrapper">
            <img
...
export default JungJiminTheWeaponDesktop;
