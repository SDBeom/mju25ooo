...
const ShimSungbinLinkedMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--shim-sungbin-linked-mobile">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--shim-sungbin-linked-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--shim-sungbin-linked-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--shim-sungbin-linked-mobile"
          />
        </div>
      </section>
