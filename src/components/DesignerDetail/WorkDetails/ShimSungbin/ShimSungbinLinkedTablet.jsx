 ...
 */
const ShimSungbinLinkedTablet = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--shim-sungbin-linked-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--shim-sungbin-linked-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--shim-sungbin-linked-tablet">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--shim-sungbin-linked-tablet">Linked</h2>
            <div className="work-detail__lead work-detail__lead--shim-sungbin-linked-tablet">
              <p className="mb-0">Linked는 점과 선, 면을 활용하여 관계의 연결과 단절, 사회의 순환적 흐름을 </p>
              <p>표현한 아트워크이다.</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--shim-sungbin-linked-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--shim-sungbin-linked-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--shim-sungbin-linked-tablet">
          <img
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--shim-sungbin-linked-tablet">
        <li className="work-detail__card work-detail__card--shim-sungbin-linked-tablet">
          ...
          <div className="work-detail__card-text">
            ...
            <div className="work-detail__card-description">
              <p className="mb-0">사회를 구성하는 개개인을 </p>
              <p className="mb-0">의미한다. 서로 유기적으로</p>
              <p>연결되어 공동체를 이룬다.</p>
            </div>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--shim-sungbin-linked-tablet">
          ...
          <div className="work-detail__card-text">
            ...
            <div className="work-detail__card-description">
              <p className="mb-0">전쟁, 질병, 재앙 등 사회의</p>
              <p className="mb-0">혼란을 의미한다. 공동체를 </p>
              <p>무너뜨리고 파괴하려 한다.</p>
            </div>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--shim-sungbin-linked-tablet">
          ...
          <div className="work-detail__card-text">
            ...
            <div className="work-detail__card-description">
              <p className="mb-0">무너진 공동체가 다시 </p>
              <p>회복하려는 탄력성을 의미한다. 서로 조화롭게 연결되어 있다.</p>
            </div>
          </div>
        </li>
      </ul>
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--shim-sungbin-linked-tablet">
        <li className="work-detail__bento-card work-detail__bento-card--shim-sungbin-linked-tablet">
        ...
        <li className="work-detail__bento-card work-detail__bento-card--shim-sungbin-linked-tablet work-detail__bento-card--wide">
          <div className="work-detail__bento-card-image-wrapper">
            <img
          ...
          <div className="work-detail__bento-card-text work-detail__bento-card-text--wide">
            ...
            <div className="work-detail__bento-card-description">
              <p className="mb-0">강렬한 붉은 색을 지닌 구슬이 수면 위로 튀어오르며 </p>
              <p>공동체를 파괴한다.</p>
            </div>
          </div>
        </li>
        <li className="work-detail__bento-card work-detail__bento-card--shim-sungbin-linked-tablet work-detail__bento-card--full">
          <div className="work-detail__bento-card-image-wrapper">
            <img
          ...
          <div className="work-detail__bento-card-text work-detail__bento-card-text--full">
            ...
            <p className="work-detail__bento-card-description">거대한 초록색 구슬이 지나가자 파괴된 구슬들은 다시 수면위로 떠오른다. 빛을 잃은 구슬들이 다시 모여 다시 공동체를 회복해내고, 이전보다 더 큰 구조를 만들어낸다.</p>
          </div>
        </li>
      </ul>

      {/* Feature Cards 3 Section */}
      <ul className="work-detail__section work-detail__cards work-detail__cards--shim-sungbin-linked-tablet work-detail__cards--feature-3">
        <li className="work-detail__card work-detail__card--shim-sungbin-linked-tablet work-detail__card--feature-3">
          <article className="work-detail__card-article">
            <div className="work-detail__card-text">
              <h5 className="work-detail__card-title">Geometry Node (Droplets)</h5>
              <p className="work-detail__card-description">블렌더의 Geometry Node 기능을 사용하여 구체 위에 맺히는 물방울들을 표현하였다.</p>
            </div>
        ...
        <li className="work-detail__card work-detail__card--shim-sungbin-linked-tablet work-detail__card--feature-3">
          <article className="work-detail__card-article">
            <div className="work-detail__card-text">
              ...
              <div className="work-detail__card-description">
                <p className="mb-0">블렌더의 Geometry Node 기능을 사용하여 여러개의 구슬들이 모여 만들어낸 </p>
                <p>구조를 표현했다.</p>
              </div>
            </div>
            <div className="work-detail__card-image-wrapper work-detail__card-image-wrapper--feature-3">
...
export default ShimSungbinLinkedTablet;
