...
import '../../styles/works/ShimSungbinBoom/ShimSungbinBoomDesktop.css';
...
const ShimSungbinBoomDesktop = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--shim-sungbin-boom-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--shim-sungbin-boom-desktop">
            ...
            <div className="work-detail__ctas work-detail__ctas--shim-sungbin-boom-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--shim-sungbin-boom-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--shim-sungbin-boom-desktop">
          <img
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--shim-sungbin-boom-desktop">
        ...
        <li className="work-detail__card work-detail__card--shim-sungbin-boom-desktop">
          ...
          <div className="work-detail__card-text">
            ...
            <p className="work-detail__card-description">우리가 자주 접하는 사무실이다. 억압되고 자유가 없는 삭막한 공간이다.</p>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--shim-sungbin-boom-desktop">
          <div className="work-detail__card-image-wrapper">
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--shim-sungbin-boom-desktop">
        ...
        <li className="work-detail__bento-card work-detail__bento-card--shim-sungbin-boom-desktop">
          ...
          <div className="work-detail__bento-card-text">
            ...
            <p className="work-detail__bento-card-description">폭발이 연속적으로 일어나며 사무실, 계단실, 회의실 등 건물의 모든곳을 덮친다.</p>
          </div>
        </li>
        <li className="work-detail__bento-card work-detail__bento-card--shim-sungbin-boom-desktop work-detail__bento-card--wide">
          <div className="work-detail__bento-card-image-wrapper">
            <img
          ...
          <div className="work-detail__bento-card-text work-detail__bento-card-text--wide">
            ...
            <p className="work-detail__bento-card-description">방금까지 본 모든 폭발이 전부 망상이였음을 노트북을 통해 알 수 있다. 현실은 여전히 바뀌지 않았음을 시사한다.</p>
          </div>
        </li>
      </ul>

      {/* Feature Cards 3 Section */}
      <ul className="work-detail__section work-detail__cards work-detail__cards--shim-sungbin-boom-desktop work-detail__cards--feature-3">
        <li className="work-detail__card work-detail__card--shim-sungbin-boom-desktop work-detail__card--feature-3">
...
export default ShimSungbinBoomDesktop;
