...
import '../../styles/works/LeeJiminLeLabo/LeeJiminLeLaboDesktop.css';
...
const LeeJiminLeLaboDesktop = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--leejimin-lelabo-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--leejimin-lelabo-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--leejimin-lelabo-desktop">
...
영상과 2D 일러스트를 수록한 아트북을 제작했다.
            ...
            <div className="work-detail__ctas work-detail__ctas--leejimin-lelabo-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--leejimin-lelabo-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--leejimin-lelabo-desktop">
          <img
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--leejimin-lelabo-desktop">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--leejimin-lelabo-desktop">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--leejimin-lelabo-desktop"
          />
        </div>
      </section>

      {/* Text Section - Imagine a city */}
      <section className="work-detail__section work-detail__text-section work-detail__text-section--leejimin-lelabo-desktop">
...
향은 눈에 보이지 않지만, 공기 속에 기억을 남긴다. 그래서 이번 작업에서는 향이 지닌 기억의 잔상과 도시가 품은 감정의 결을 시각적으로 구현하는 데 집중하였다. 각 도시를 대표하는 메인 컬러를 중심으로, 그곳의 기온, 빛의 방향, 공기의 밀도, 사람들의 움직임 등 향으로는 포착할 수 없는 요소들을 영상으로 표현하고자 했다.</p>
      ...
      <section className="work-detail__section work-detail__feature-cards work-detail__feature-cards--leejimin-lelabo-desktop">
...
전체적으로 화사하면서도 따스한 느낌의 색감을 사용했다.</p>
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--leejimin-lelabo-desktop">
...
색감을 사용했다.</p>
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--leejimin-lelabo-desktop">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--leejimin-lelabo-desktop">
          <img
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--leejimin-lelabo-desktop">
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--leejimin-lelabo-desktop">
...
export default LeeJiminLeLaboDesktop;
