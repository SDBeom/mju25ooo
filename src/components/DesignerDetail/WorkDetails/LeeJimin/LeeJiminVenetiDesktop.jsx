...
import '../../styles/works/LeeJiminVeneti/LeeJiminVenetiDesktop.css';
...
const LeeJiminVenetiDesktop = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--leejimin-veneti-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--leejimin-veneti-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--leejimin-veneti-desktop">
...
영상과 2D 일러스트를 수록한 아트북을 제작했다.
            ...
            <div className="work-detail__ctas work-detail__ctas--leejimin-veneti-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--leejimin-veneti-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--leejimin-veneti-desktop">
          <img
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--leejimin-veneti-desktop">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--leejimin-veneti-desktop">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--leejimin-veneti-desktop"
          />
        </div>
      </section>

      {/* Text Section - Dream of freedom */}
      <section className="work-detail__section work-detail__text-section work-detail__text-section--leejimin-veneti-desktop">
...
또한 캐릭터의 활기찬 모습을 표현하기 위해 리깅 후 역동적인 포즈를 연출하였고, 세계관의 완성도를 높이기 위해 러프한 2D 아트워크부터 세부 디자인까지과정을 정리해 아트북으로 제작했다.</p>
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--leejimin-veneti-desktop">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--leejimin-veneti-desktop">
          <img
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--leejimin-veneti-desktop">
...
진행하고 아트북에 수록하였다.</p>
      ...
      <ul className="work-detail__section work-detail__feature-bento work-detail__feature-bento--leejimin-veneti-desktop">
        <li className="work-detail__feature-bento-grid">
...
export default LeeJiminVenetiDesktop;
