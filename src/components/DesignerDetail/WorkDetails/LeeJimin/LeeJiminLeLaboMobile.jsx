...
import '../../styles/works/LeeJiminLeLabo/LeeJiminLeLaboMobile.css';
...
const LeeJiminLeLaboMobile = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--leejimin-lelabo-mobile">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--leejimin-lelabo-mobile">
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--leejimin-lelabo-mobile">
          <img
        ...
        <div className="work-detail__hero-content work-detail__hero-content--leejimin-lelabo-mobile">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--leejimin-lelabo-mobile">
              LE LABO-CITY EXCLUSIVE
            </h2>
            <div className="work-detail__lead work-detail__lead--leejimin-lelabo-mobile">
              <p>니치 향수 브랜드 'LE LABO'의 City Exclusive 향수 중 CITRON, GAIAC, MUSC 세 가지 향수를 주제로 한 프로모션 영상이다.</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--leejimin-lelabo-mobile">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--leejimin-lelabo-mobile`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      <section className="work-detail__section work-detail__text-section work-detail__text-section--leejimin-lelabo-mobile">
        ...
        <div className="work-detail__text-section-description">
          <p className="mb-0">이 프로젝트는 단순히 제작품을 소개하는 영상을 넘어서, "향이 인간의 감정에 어떻게 닿는가"라는 질문에서 출발한 프로젝트이다.</p>
          <p className="mb-0">향은 눈에 보이지 않지만, 공기 속에 기억을 남긴다. 그래서 이번 작업에서는 향이 지닌 기억의 잔상과 도시가 작품은 감정의 결을</p>
          <p className="mb-0">시각적으로 구현하는 데 집중하였다.</p>
          <p className="mb-0">각 도시를 대표하는 메인 컬러를 중심으로, 그곳의 기온, 빛의 방향, 공기의 밀도, 사람들의 움직임 등 향으로는 포착할 수 없는</p>
          <p>요소들을 영상으로 표현하고자 했다.</p>
        </div>
      </section>

      {/* Feature Cards Section - Fresh */}
      <section className="work-detail__section work-detail__feature-cards work-detail__feature-cards--leejimin-lelabo-mobile">
        ...
        <div className="work-detail__feature-cards-content">
          <div className="work-detail__feature-cards-text">
            ...
            <p className="mb-0">CITRON28은 서울의 아침에서 느껴지는</p>
            <p>시원함을 표현하고자 전체적으로 화사하면서도 따한 느낌의 색감을 사용했다.</p>
          </div>
        </div>
      </section>

      {/* Feature Rows Section */}
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--leejimin-lelabo-mobile">
        <li className="work-detail__feature-row">
          ...
          <div className="work-detail__feature-row-content">
            <div className="work-detail__feature-row-text">
              ...
              <p className="mb-0">GAIAC10은 도시에서도 느껴지는 풀내음을 표현하고자 싱그러우면서도 습한 느낌의</p>
              <p>색감을 사용했다.</p>
            </div>
          </div>
        </li>
        <li className="work-detail__feature-row">
          ...
          <div className="work-detail__feature-row-content">
            <div className="work-detail__feature-row-text">
              ...
              <p className="mb-0">MUSC25는 아침과 저녁이 주는 서로 다른 느낌의 긴 여운을 시각적으로 표현하고자</p>
              <p>영상의 초반부에는 따한 색감을, 후반부에는 짙고 어두운 색감을 사용했다.</p>
            </div>
          </div>
        </li>
      </ul>
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--leejimin-lelabo-mobile">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--leejimin-lelabo-mobile">
          <img
        ...
        <div className="work-detail__feature-text">
          ...
          <p>정보를 함께 제시했다. 이를 통해 시청자가 향수의 향과 그에 어울리는 도시의 이미지를 자연럽게 떠올릴 수 있도록 연출했다.</p>
        </div>
      </section>

      {/* Feature Cards Section - 3 Cards */}
      <ul className="work-detail__section work-detail__cards work-detail__cards--leejimin-lelabo-mobile">
        <li className="work-detail__card work-detail__card--leejimin-lelabo-mobile">
        ...
        <li className="work-detail__card work-detail__card--leejimin-lelabo-mobile">
          ...
          <div className="work-detail__card-text">
            ...
            <p className="mb-0">로엔젤레에서 영감 받아 제작된 시티</p>
            <p>익클루시브의 오래된 컬렉션 중 하나.</p>
          </div>
        </li>
      </ul>

      {/* Gallery Section - Photo shoot */}
      <section className="work-detail__section work-detail__gallery work-detail__gallery--leejimin-lelabo-mobile">
...
export default LeeJiminLeLaboMobile;
