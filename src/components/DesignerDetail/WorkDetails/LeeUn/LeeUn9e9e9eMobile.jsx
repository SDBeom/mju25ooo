...
import '../../styles/works/LeeUn9e9e9e/LeeUn9e9e9eMobile.css';
...
const LeeUn9e9e9eMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--leeun-9e9e9e-mobile">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--leeun-9e9e9e-mobile">
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--leeun-9e9e9e-mobile">
          <img
            src={leeunWork2_01}
        ...
        <div className="work-detail__hero-content work-detail__hero-content--leeun-9e9e9e-mobile">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--leeun-9e9e9e-mobile">
              9e9e9e
            </h2>
            <div className="work-detail__lead work-detail__lead--leeun-9e9e9e-mobile">
              <p>리본과 마법소녀의 모티프로, 일상에 다정한 귀여움을 묶어주는 디자인 문구 & 액세서리 브랜드 브랜딩</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--leeun-9e9e9e-mobile">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--leeun-9e9e9e-mobile`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      {/* Feature Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--leeun-9e9e9e-mobile">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--leeun-9e9e9e-mobile">
          <img
            src={leeunWork2_02}
            alt="9e9e9e"
        ...
        <div className="work-detail__feature-text">
          ...
          <div className="work-detail__feature-description">
            ...
            <p className="mb-0">반복되는 알파벳과 숫자로 이루어진 브랜드</p>
      ...
      {/* Core Value Section */}
      <section className="work-detail__section work-detail__core-value work-detail__core-value--leeun-9e9e9e-mobile">
          ...
          <li className="work-detail__core-value-column work-detail__core-value-column--2">
            <div className="work-detail__core-value-card">
              <div className="work-detail__core-value-card-content">
                ...
                <div className="work-detail__core-value-text">
                  <p className="mb-16">어떤 상황에서도 자신을 표현할 수 있는</p>
                  <p>자유</p>
                </div>
              </div>
            </div>
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--leeun-9e9e9e-mobile">
...
export default LeeUn9e9e9eMobile;
