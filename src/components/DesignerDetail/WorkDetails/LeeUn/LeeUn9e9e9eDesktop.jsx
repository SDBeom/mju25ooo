 ...
 */
const LeeUn9e9e9eDesktop = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--leeun-9e9e9e-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--leeun-9e9e9e-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--leeun-9e9e9e-desktop">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--leeun-9e9e9e-desktop">
              9e9e9e
            </h2>
            <div className="work-detail__lead work-detail__lead--leeun-9e9e9e-desktop">
              <p>리본과 마법소녀의 모티프로, 일상에 다정한 귀여움을 묶어주는 디자인 문구 & 액세서리 브랜드 브랜딩</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--leeun-9e9e9e-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--leeun-9e9e9e-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--leeun-9e9e9e-desktop">
          <img
            src={leeunWork2_01}
      ...
      {/* Feature Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--leeun-9e9e9e-desktop">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--leeun-9e9e9e-desktop">
          <img
            src={leeunWork2_02}
            alt="9e9e9e"
        ...
        <div className="work-detail__feature-text">
          ...
          <div className="work-detail__feature-description">
            <p className="mb-0">'9e9e9e'는 디자인 문구 & 액세서리 브랜드로, 어떤 모습이든, 어떤 상황이든, 어디에 있든 누구나 귀여워질 수 있다는 긍정적인 메세지를 전합니다.</p>
            <p className="mb-0">반복되는 알파벳과 숫자로 이루어진 브랜드 이름은 리본의 형태를 닮아, 일상 속에서 자연럽게 묶이는 귀여움의 상징이 됩니다.</p>
            <p className="mb-0">&nbsp;</p>
            <p>'9e9e9e'는 리본과 마법소녀의 이미지를 모티프로 작은 소작품이 평범한 하루에 다정한 마법으로 며들길 바랍니다.</p>
          </div>
        </div>
      </section>

      {/* Core Value Section */}
      <section className="work-detail__section work-detail__core-value work-detail__core-value--leeun-9e9e9e-desktop">
            ...
            <div className="work-detail__core-value-card">
              <div className="work-detail__core-value-card-content">
                ...
                <div className="work-detail__core-value-text">
                  <p className="mb-16">누구나 즐길 수 있는 가장 보편적인</p>
                  <p>감정으로 접근성이 좋도록 함</p>
                </div>
              </div>
            </div>
          ...
          <li className="work-detail__core-value-column work-detail__core-value-column--2">
            <div className="work-detail__core-value-card">
              <div className="work-detail__core-value-card-content">
                ...
                <div className="work-detail__core-value-text">
                  <p className="mb-16">어떤 상황에서도 자신을 표현할 수</p>
                  <p>있는 자유</p>
                </div>
              </div>
            </div>
            <div className="work-detail__core-value-card">
              <div className="work-detail__core-value-card-content">
                ...
                <div className="work-detail__core-value-text">
                  <p className="mb-16">일상속의 예상치 못한 무겁고 심각한</p>
                  <p className="mb-16">순간들을 가볍고 유쾌하게 넘어가는</p>
                  <p>태도</p>
                </div>
              </div>
            </div>
          ...
          <li className="work-detail__core-value-column work-detail__core-value-column--3">
            <div className="work-detail__core-value-card">
              <div className="work-detail__core-value-card-content">
                ...
                <div className="work-detail__core-value-text">
                  <p className="mb-16">브랜드 자체의 긍정적인 사고와 그것을</p>
                  <p>전파하려는 태도</p>
                </div>
              </div>
            </div>
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--leeun-9e9e9e-desktop">
...
export default LeeUn9e9e9eDesktop;
