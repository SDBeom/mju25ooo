...
import '../../styles/works/LeeUnLayered/LeeUnLayeredDesktop.css';
...
/**
 * 이운 - Layered (작품1) Desktop 버전
 * Figma 디자인 기반 구현 (1280px)
 */
const LeeUnLayeredDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--leeun-layered-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--leeun-layered-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--leeun-layered-desktop">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--leeun-layered-desktop">
              Layered
            </h2>
            <div className="work-detail__lead work-detail__lead--leeun-layered-desktop">
              <p>개인의 정체성을 형성하는 다층적인 '겹쳐짐'에 집중한 컨셔 패션 브랜드 브랜딩</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--leeun-layered-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--leeun-layered-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--leeun-layered-desktop">
          <img
            src={leeunWork1_01}
      ...
      {/* Text Section */}
      <section className="work-detail__section work-detail__text-section work-detail__text-section--leeun-layered-desktop">
        ...
        <div className="work-detail__text-section-description">
          <p className="mb-0">겹쳐짐은 개인의 정체성을 형성하는 다층적인 요소들을 상징합니다. 인간의 정체성은 단일하지 않으며, 경험, 환경, 관계 등 수많은 요소들이 겹치면서</p>
          <p className="mb-0">완성됩니다. 'Layered'는 시간이 지나 입지 못하게 되었지만 기억이 담긴 소중한 옷을 업사이클링하여 새로운 타일로 재탄생시키는 브랜드입니다. 과거와 현재가 조화를 이루는 디자인을 통해, 우리는 단순한 리폼을 넘어 기억과 개성, 지속 가능성을 연결하는 패션을 제안합니다.</p>
          <p className="mb-0">&nbsp;</p>
          <p>또한, 'Layered'는 패트 패션을 지양하는 컨셔 브랜드로서, 소유보다 활용 중심의 지속 가능한  지향합니다. 버려지는 옷이 아닌, 소중한 기억이 담긴 옷을 새롭게 디자인함으로써 패션의 순환과 환경 보호를 실천합니다.</p>
        </div>
      </section>

      {/* Gallery Section - LOOK */}
      <section className="work-detail__section work-detail__gallery work-detail__gallery--leeun-layered-desktop">
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--leeun-layered-desktop">
        <li className="work-detail__feature-row work-detail__feature-row--leeun-layered-desktop">
          ...
          <div className="work-detail__feature-content">
            <div className="work-detail__text-group">
              ...
              <div className="work-detail__feature-description">
                <p className="mb-0">옷은 단순히 몸을 가리는 도구가 아니라, 나를 드러내는 가장 직접적인</p>
                <p className="mb-0">언어입니다. Layered는 과거와 현재의 옷을 새롭게 잇는 과정 속에서</p>
                <p className="mb-0">나만의 이야기를 담습니다. 더이상 입을 수 없지만 소중한 기억이 깃든</p>
                <p className="mb-0">옷을 리폼해  개인의 취향과 경험이 고란히 반영된 </p>
                <p className="mb-0">완성합니다. 이 과정에서 옷은 단순한 패션 아이템을 넘어, 자기 표현의</p>
                <p>매개체가 됩니다.</p>
              </div>
            </div>
          </div>
        </li>
        <li className="work-detail__feature-row work-detail__feature-row--leeun-layered-desktop work-detail__feature-row--reverse">
          <div className="work-detail__feature-image-wrapper">
            <img
              src={leeunWork1_10}
              alt="Rich"
          ...
          <div className="work-detail__feature-content">
            <div className="work-detail__text-group">
              ...
              <div className="work-detail__feature-description">
                <p className="mb-0">오래 함께한 옷에는 이미 그 시간을 함께한 기존의 기억이 며 있고, 그</p>
                <p className="mb-0">옷을 새롭게 다듬고 변주하는 과정에서 또 다른 새로운 기억이 차곡차곡</p>
                <p className="mb-0">더해집니다. 이렇게 과거와 현재가 겹쳐지며 형성된 흔적은 옷을 단순한</p>
                <p className="mb-0">의복이 아닌 정체성과 기억이 중첩된 서사적 매체로 바꾸어 줍니다. Layered는 이 겹쳐진 기억과 정체성을 통해 풍부하고 입체적인</p>
                <p>아름다움을 완성합니다.</p>
              </div>
            </div>
          </div>
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--leeun-layered-desktop-2">
        <li className="work-detail__feature-row work-detail__feature-row--leeun-layered-desktop">
          <div className="work-detail__feature-image-wrapper">
            <img
              src={leeunWork1_11}
          ...
          <div className="work-detail__feature-content">
            <div className="work-detail__text-group">
              ...
              <div className="work-detail__feature-description">
                <p className="mb-0">Layered의 옷은 하나의 형태에 머무르지 않습니다. 같은 옷이라도</p>
                <p className="mb-0">타일링의 변주, 시간이 더해지며 달라지는 해석에 따라 새로운 모습을</p>
                <p className="mb-0">드러냅니다. 이는 끊임없이 흐르고 변하는 자연, 구름의 층위와 닮아</p>
                <p className="mb-0">있으며, 입는 사람의 개성과 순간의 감정에 따라 다양하게 적응하는 옷으로 완성됩니다. Layered가 추구하는 유연성은 곧 오래도록 입을 수 있는</p>
        ...
        <li className="work-detail__feature-row work-detail__feature-row--leeun-layered-desktop work-detail__feature-row--reverse">
          ...
          <div className="work-detail__feature-content">
            <div className="work-detail__text-group">
              ...
              <div className="work-detail__feature-description">
                <p className="mb-0">빠르게 소비되고 잊혀지는 패트 패션과 달리, Layered는 옷이 가진</p>
                <p className="mb-0">시간을 존중합니다. 오래 입을 수 있도록 튼튼하게,  또 다른 방식으로 다시 활용할 수 있도록 유연하게 디자인합니다. 기존의 옷을 해체하고</p>
                <p className="mb-0">재구성하거나,  남겨진 원단을 새로운 옷으로 이어붙이며, 옷이 가진</p>
                <p className="mb-0">생명을 이어갑니다. Layered는 패트 패션을 지양하고 옷을 오래</p>
                <p className="mb-0">활용하는 방식을 추구합니다. 기존의 옷을 새롭게 해석해, 오래도록</p>
                <p>이어지는 패션을 지향합니다.</p>
              </div>
            </div>
          </div>
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--leeun-layered-desktop">
        <li className="work-detail__card work-detail__card--leeun-layered-desktop">
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--leeun-layered-desktop">
        <li className="work-detail__bento-card work-detail__bento-card--leeun-layered-desktop">
        ...
        <li className="work-detail__bento-card work-detail__bento-card--leeun-layered-desktop work-detail__bento-card--wide">
          <div className="work-detail__bento-image-wrapper">
            <img
              src={leeunWork1_17}
              alt="Web"
...
export default LeeUnLayeredDesktop;
