        ...
        <div className="work-detail__hero-content work-detail__hero-content--song-dahee-a-card-of-love-tablet">
          <div className="work-detail__text-group">
            ...
            <div className="work-detail__lead work-detail__lead--song-dahee-a-card-of-love-tablet">
              ...
              <p className="mb-0">현대 사회 속 감정의 언어를</p>
              <p className="mb-0">다시 배우기 위한 시도이다. </p>
              <p>&nbsp;</p>
            </div>
          </div>
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--song-dahee-a-card-of-love-tablet">
        ...
        <li className="work-detail__card work-detail__card--song-dahee-a-card-of-love-tablet">
          ...
          <div className="work-detail__card-text">
            ...
            <div className="work-detail__card-description">
              <p className="mb-0">오랫동안 눌렀던 </p>
              <p className="mb-0">감정이 폭발하려 합니다.</p>
              <p className="mb-0">화가 될 수도 있고,</p>
              <p>열정이 될 수도 있습니다.</p>
            </div>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--song-dahee-a-card-of-love-tablet">
          ...
          <div className="work-detail__card-text">
            ...
            <div className="work-detail__card-description">
              <p className="mb-0">사랑은 때때로 말없이</p>
              <p className="mb-0">다정하게 다가옵니다.</p>
              <p>사과처럼 부드럽고, 달콤하게.</p>
            </div>
          </div>
        </li>
