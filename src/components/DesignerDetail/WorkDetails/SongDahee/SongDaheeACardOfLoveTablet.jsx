...
import '../../styles/works/SongDaheeACardOfLove/SongDaheeACardOfLoveTablet.css';
...
const SongDaheeACardOfLoveTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--song-dahee-a-card-of-love-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--song-dahee-a-card-of-love-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--song-dahee-a-card-of-love-tablet">
          ...
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--song-dahee-a-card-of-love-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--song-dahee-a-card-of-love-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--song-dahee-a-card-of-love-tablet">
          <img
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--song-dahee-a-card-of-love-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--song-dahee-a-card-of-love-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--song-dahee-a-card-of-love-tablet"
          />
        </div>
      </section>

      {/* Feature Cards 1 Section */}
      <ul className="work-detail__section work-detail__cards work-detail__cards--song-dahee-a-card-of-love-tablet">
        <li className="work-detail__card work-detail__card--song-dahee-a-card-of-love-tablet">
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--song-dahee-a-card-of-love-tablet">
...
export default SongDaheeACardOfLoveTablet;
