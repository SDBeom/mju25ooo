...
const SongDaheePeonyTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--song-dahee-peony-tablet">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--song-dahee-peony-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--song-dahee-peony-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--song-dahee-peony-tablet"
          />
        </div>
      </section>
