...
import '../../styles/works/SongDaheeACardOfLove/SongDaheeACardOfLoveDesktop.css';
...
/**
 * 송다희 - A Card of Love (작품1) Desktop 버전
 * Figma 디자인 기반 구현 (1280px)
 */
const SongDaheeACardOfLoveDesktop = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--song-dahee-a-card-of-love-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--song-dahee-a-card-of-love-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--song-dahee-a-card-of-love-desktop">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--song-dahee-a-card-of-love-desktop">A Card of Love</h2>
            <div className="work-detail__lead work-detail__lead--song-dahee-a-card-of-love-desktop">
              <p className="mb-0">A Card of Love는 사랑을 표현하는 데</p>
              <p className="mb-0">서툰 이들을 위한 감정 탐구 프로젝트이자,</p>
              <p className="mb-0">현대 사회 속 감정의 언어를 다시 배우기 위한 </p>
              <p className="mb-0">시도이다. </p>
              <p>&nbsp;</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--song-dahee-a-card-of-love-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--song-dahee-a-card-of-love-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--song-dahee-a-card-of-love-desktop">
          <img
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--song-dahee-a-card-of-love-desktop">
...
export default SongDaheeACardOfLoveDesktop;
