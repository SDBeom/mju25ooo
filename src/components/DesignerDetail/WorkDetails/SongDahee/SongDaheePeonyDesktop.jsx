...
const SongDaheePeonyDesktop = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--song-dahee-peony-desktop">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--song-dahee-peony-desktop">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--song-dahee-peony-desktop">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--song-dahee-peony-desktop"
          />
        </div>
      </section>
        ...
        <li className="work-detail__feature-row work-detail__feature-row--song-dahee-peony-desktop">
          ...
          <div className="work-detail__feature-row-content">
            ...
            <div className="work-detail__feature-row-description">
              <p>물속에<br />연꽃은 연꽃이 아니고 모란은 모란이 아니고 복숭아는 복숭아가 아니어서</p>
            </div>
          </div>
        </li>
        <li className="work-detail__feature-row work-detail__feature-row--song-dahee-peony-desktop">
