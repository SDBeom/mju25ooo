...
const DoTienHongSeeTinhAnimatedMvMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--do-tien-hong-see-tinh-animated-mv-mobile">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--do-tien-hong-see-tinh-animated-mv-mobile">
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--do-tien-hong-see-tinh-animated-mv-mobile">
          <img
        ...
        <div className="work-detail__hero-content work-detail__hero-content--do-tien-hong-see-tinh-animated-mv-mobile">
          <div className="work-detail__text-group work-detail__text-group--do-tien-hong-see-tinh-animated-mv-mobile">
            <h2 className="work-detail__title work-detail__title--do-tien-hong-see-tinh-animated-mv-mobile">"SEE TINH" ANIMATED MV</h2>
            <div className="work-detail__lead work-detail__lead--do-tien-hong-see-tinh-animated-mv-mobile">
          ...
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--do-tien-hong-see-tinh-animated-mv-mobile">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--do-tien-hong-see-tinh-animated-mv-mobile`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      {/* Feature Section 1 */}
      <section className="work-detail__section work-detail__feature work-detail__feature--do-tien-hong-see-tinh-animated-mv-mobile">
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature-image-only work-detail__feature-image-only--do-tien-hong-see-tinh-animated-mv-mobile">
        <div className="work-detail__feature-image-wrapper">
          <img
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature-centered work-detail__feature-centered--do-tien-hong-see-tinh-animated-mv-mobile">
        <div className="work-detail__feature-image-wrapper">
          <img
...
export default DoTienHongSeeTinhAnimatedMvMobile;
