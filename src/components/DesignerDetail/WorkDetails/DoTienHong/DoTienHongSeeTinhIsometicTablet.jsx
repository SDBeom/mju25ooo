...
const DoTienHongSeeTinhIsometicTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--do-tien-hong-see-tinh-isometic-tablet">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--do-tien-hong-see-tinh-isometic-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--do-tien-hong-see-tinh-isometic-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--do-tien-hong-see-tinh-isometic-tablet"
          />
        </div>
      </section>
