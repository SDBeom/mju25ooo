...
const KimJaeeunGoFetchMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--kim-jaeeun-go-fetch-mobile">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--kim-jaeeun-go-fetch-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--kim-jaeeun-go-fetch-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--kim-jaeeun-go-fetch-mobile"
          />
        </div>
      </section>
