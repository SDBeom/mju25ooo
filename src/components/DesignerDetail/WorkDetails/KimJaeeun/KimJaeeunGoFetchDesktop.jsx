...
import '../../styles/works/KimJaeeunGoFetch/KimJaeeunGoFetchDesktop.css';
...
const KimJaeeunGoFetchDesktop = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--kim-jaeeun-go-fetch-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-jaeeun-go-fetch-desktop">
            ...
            <div className="work-detail__ctas work-detail__ctas--kim-jaeeun-go-fetch-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--kim-jaeeun-go-fetch-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--kim-jaeeun-go-fetch-desktop">
          <img
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--kim-jaeeun-go-fetch-desktop">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--kim-jaeeun-go-fetch-desktop">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--kim-jaeeun-go-fetch-desktop"
          />
        </div>
      </section>

      {/* Feature Section - To The End, For You */}
      <section className="work-detail__section work-detail__feature work-detail__feature--kim-jaeeun-go-fetch-desktop">
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--kim-jaeeun-go-fetch-desktop">
      ...
      {/* Feature Cards - Story Cards */}
      <ul className="work-detail__section work-detail__feature-story-cards work-detail__feature-story-cards--kim-jaeeun-go-fetch-desktop">
...
export default KimJaeeunGoFetchDesktop;
