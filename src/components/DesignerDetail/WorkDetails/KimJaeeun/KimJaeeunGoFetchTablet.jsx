...
import '../../styles/works/KimJaeeunGoFetch/KimJaeeunGoFetchTablet.css';
...
const KimJaeeunGoFetchTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--kim-jaeeun-go-fetch-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-jaeeun-go-fetch-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--kim-jaeeun-go-fetch-tablet">
...
2D·3D 단편 애니메이션.`}
          ...
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--kim-jaeeun-go-fetch-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--kim-jaeeun-go-fetch-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--kim-jaeeun-go-fetch-tablet">
          <img
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--kim-jaeeun-go-fetch-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--kim-jaeeun-go-fetch-tablet">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/NQ9LfQJf-cg?si=XE4ShAPT4xHcpTpw&controls=0"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerPolicy="strict-origin-when-cross-origin"
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--kim-jaeeun-go-fetch-tablet"
          />
        </div>
      </section>

      {/* Feature Section - To The End, For You */}
      <section className="work-detail__section work-detail__feature work-detail__feature--kim-jaeeun-go-fetch-tablet">
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--kim-jaeeun-go-fetch-tablet">
...
누리와 가온을 이별시키게 한 주범이다.`}
      ...
      <section className="work-detail__section work-detail__feature-gallery work-detail__feature-gallery--kim-jaeeun-go-fetch-tablet">
      ...
      <ul className="work-detail__section work-detail__feature-story-cards work-detail__feature-story-cards--kim-jaeeun-go-fetch-tablet">
        <li className="work-detail__feature-story-card">
          ...
          <div className="work-detail__feature-story-card-body">
            ...
            <div className="work-detail__feature-story-card-description">
              <p>막막하고 두려운 이별, 공포 속에서 홀로 남겨진 누리.</p>
            </div>
          </div>
        </li>
        <li className="work-detail__feature-story-card">
...
export default KimJaeeunGoFetchTablet;
