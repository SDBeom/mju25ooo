...
const KimJaeeunPetrichorTablet = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--kim-jaeeun-petrichor-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-jaeeun-petrichor-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--kim-jaeeun-petrichor-tablet">
          ...
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--kim-jaeeun-petrichor-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--kim-jaeeun-petrichor-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--kim-jaeeun-petrichor-tablet">
          <img
      ...
      <ul className="work-detail__section work-detail__feature-bento work-detail__feature-bento--kim-jaeeun-petrichor-tablet">
        ...
        <li className="work-detail__feature-bento-card work-detail__feature-bento-card--medium">
          <div className="work-detail__feature-bento-image-wrapper">
            <img
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--kim-jaeeun-petrichor-tablet">
...
export default KimJaeeunPetrichorTablet;
