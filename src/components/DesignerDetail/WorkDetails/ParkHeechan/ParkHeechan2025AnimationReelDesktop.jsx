...
const ParkHeechan2025AnimationReelDesktop = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--park-heechan-2025-animation-reel-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--park-heechan-2025-animation-reel-desktop">
            ...
            <div className="work-detail__ctas work-detail__ctas--park-heechan-2025-animation-reel-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--park-heechan-2025-animation-reel-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--park-heechan-2025-animation-reel-desktop">
          <img
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--park-heechan-2025-animation-reel-desktop">
      ...
      {/* Feature Cards 1 */}
      <ul className="work-detail__section work-detail__cards work-detail__cards--park-heechan-2025-animation-reel-desktop">
...
export default ParkHeechan2025AnimationReelDesktop;
