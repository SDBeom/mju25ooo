...
import '../../styles/works/ParkHeechanPledge/ParkHeechanPledgeTablet.css';
...
/**
 * 박희찬 - PLEDGE Tablet 버전
 * Figma 디자인 기반 구현 (800px)
 */
const ParkHeechanPledgeTablet = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--park-heechan-pledge-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--park-heechan-pledge-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--park-heechan-pledge-tablet">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--park-heechan-pledge-tablet">PLEDGE</h2>
            <p className="work-detail__lead work-detail__lead--park-heechan-pledge-tablet">
              영원한 충성, 서약
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--park-heechan-pledge-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--park-heechan-pledge-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--park-heechan-pledge-tablet">
          <img
      ...
      {/* Feature 3 */}
      <section className="work-detail__section work-detail__feature work-detail__feature--park-heechan-pledge-tablet">
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--park-heechan-pledge-tablet">
        <li className="work-detail__feature-row work-detail__feature-row--park-heechan-pledge-tablet">
...
병기화 된 관, 드레드노트에 안치한다.`}
      ...
      {/* Feature Bento 1 */}
      <ul className="work-detail__section work-detail__bento work-detail__bento--park-heechan-pledge-tablet">
        <li className="work-detail__bento-card work-detail__bento-card--park-heechan-pledge-tablet">
...
않는 무자비한 종족이다.`}
        ...
        <li className="work-detail__bento-card work-detail__bento-card--park-heechan-pledge-tablet work-detail__bento-card--wide">
          <div className="work-detail__bento-image-wrapper">
            <img
...
보여준다.`}
        ...
        <li className="work-detail__bento-card work-detail__bento-card--park-heechan-pledge-tablet work-detail__bento-card--full">
          <div className="work-detail__bento-image-wrapper">
            <img
...
강력한 대전차병기로 상대하라는 지침이 있을정도로 위협수준이 높다.`}
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--park-heechan-pledge-tablet">
...
export default ParkHeechanPledgeTablet;
