 ...
 */
const ParkHeechanPledgeTablet = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }
    ...
    <div className="work-detail work-detail--park-heechan-pledge-tablet">
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--park-heechan-pledge-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--park-heechan-pledge-tablet">
          <div className="work-detail__text-group">
            ...
            <div className="work-detail__lead work-detail__lead--park-heechan-pledge-tablet">
              <p>영원한 충성, 서약</p>
            </div>
          </div>
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--park-heechan-pledge-tablet">
        ...
        <div className="work-detail__feature-text">
          <h4 className="work-detail__feature-title">영원한 충성, 그리고 서약에 관한 이야기</h4>
          ...
          <div className="work-detail__feature-row-content">
            <div className="work-detail__feature-row-text">
              ...
              <div className="work-detail__feature-row-description">
                ...
                <p>속해있다. 20가지가 넘는 수술을 통해 덩치,</p>
                <p>감각과 근력 등  신체의 모든 부분이 강화가</p>
                <p>되었다. 이러한 초인적인 신체능력을 토대로</p>
                <p>강한 전투력을 가지고 있으며 인류 제국의</p>
                <p>최후의 보루이자 희망이다.</p>
              </div>
            </div>
          </div>
        ...
        <li className="work-detail__feature-row work-detail__feature-row--park-heechan-pledge-tablet">
          ...
          <div className="work-detail__feature-row-content">
            <div className="work-detail__feature-row-text">
              ...
              <div className="work-detail__feature-row-description">
                <p>초인적인 육체로도 버틸 수 없는 심각한 부상을 입은 페이  마린들 중 강인하고 의지가</p>
                <p>불타오르는 베테랑 마린들을 수술을 통해</p>
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--park-heechan-pledge-tablet">
        ...
        <li className="work-detail__bento-card work-detail__bento-card--park-heechan-pledge-tablet work-detail__bento-card--wide">
          ...
          <div className="work-detail__bento-text">
            ...
            <div className="work-detail__bento-description">
              <p>주변의 하위 타이라니드에게 하이브 마인드의 명령을</p>
              <p>전달해주는 시냅 크리쳐이자 전투 크리쳐.</p>
              <p>두꺼운 외골격과 훙폭성으로 페이 마린들과의</p>
              <p>상대에서도 밀리지 않고 오히려 더 강한 모습도 보여준다.</p>
            </div>
          </div>
        </li>
