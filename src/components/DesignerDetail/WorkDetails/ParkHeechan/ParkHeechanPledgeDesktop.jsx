...
// 이미지 임포트
import parkHeechanWork1_01 from '../../../../assets/박희찬/parkheechan_gamecontent_work1_01.webp';
 ...
 */
const ParkHeechanPledgeDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--park-heechan-pledge-desktop">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--park-heechan-pledge-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--park-heechan-pledge-desktop">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--park-heechan-pledge-desktop">PLEDGE</h2>
            <p className="work-detail__lead work-detail__lead--park-heechan-pledge-desktop">
              영원한 충성, 서약
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--park-heechan-pledge-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--park-heechan-pledge-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--park-heechan-pledge-desktop">
          <img
      ...
      {/* Feature 3 */}
      <section className="work-detail__section work-detail__feature work-detail__feature--park-heechan-pledge-desktop">
        ...
        <div className="work-detail__feature-text">
          <h4 className="work-detail__feature-title">영원한 충성, 서약에 관한 이야기</h4>
          <p className="work-detail__feature-description">
            {`몰려드는 적들을 향해 그는 마지막 총을 들었다. 혼자 남은 그는 전혀 두렵지 않다. 그 침묵 속에서 맹세는 불타오른다.`}
          </p>
        </div>
      </section>

      {/* Feature Cards 1: Space Marine & Dreadnought */}
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--park-heechan-pledge-desktop">
        <li className="work-detail__feature-row work-detail__feature-row--park-heechan-pledge-desktop">
          <div className="work-detail__feature-row-content">
            <div className="work-detail__feature-row-text">
              ...
              <p className="work-detail__feature-row-description">
                {`인류 제국의 강화인간이며 군사 집단에 속해있다.
20가지가 넘는 수술을 받아 덩치, 감각과 근력 등 신체의 모든 부분이
강화가 되었다. 이러한 초인적인 신체능력을 토대로 강한 전투력을 가지고 있으며 인류 제국의 최후의 보루이자 희망이다.`}
              </p>
            </div>
          </div>
        ...
        <li className="work-detail__feature-row work-detail__feature-row--park-heechan-pledge-desktop work-detail__feature-row--reverse">
          <div className="work-detail__feature-row-content">
            <div className="work-detail__feature-row-text">
              <h4 className="work-detail__feature-row-title">드레드노트</h4>
              <p className="work-detail__feature-row-description">
                {`초인적인 육체로도 버틸 수 없는 심각한 부상을 입은 스페이스 
마린들 중 강인하고 의지가 불타오르는 베테랑 마린들을 수술을 통해 
병기화 된 관, 드레드노트에 안치한다.`}
              </p>
            </div>
          </div>
      ...
      {/* Feature Bento 1 */}
      <ul className="work-detail__section work-detail__bento work-detail__bento--park-heechan-pledge-desktop">
        <li className="work-detail__bento-card work-detail__bento-card--park-heechan-pledge-desktop">
          ...
          <div className="work-detail__bento-text">
            ...
            <p className="work-detail__bento-description">
              {`타이라이드 종족은 무한에 가까운 개체 수, 시냅스로 이어진 정신, 파괴본능 등으로 인해 상대하기 
까다로우며 휩쓸고 지나간 자리는 그 어떤것도 남지 
않는 무자비한 종족이다.`}
            </p>
          </div>
        </li>
        <li className="work-detail__bento-card work-detail__bento-card--park-heechan-pledge-desktop work-detail__bento-card--wide">
          <div className="work-detail__bento-image-wrapper">
            <img
          ...
          <div className="work-detail__bento-text">
            ...
            <p className="work-detail__bento-description">
              {`주변의 하위 타이라니드에게 하이브 마인드의 명령을 전달해주는 시냅스 크리쳐이자 전투 크리쳐.
두꺼운 외골격과 훙폭성으로 스페이스 마린들과의 상대에서도 밀리지 않고 오히려 더 강한 모습도
보여준다.`}
            </p>
          </div>
        </li>
        <li className="work-detail__bento-card work-detail__bento-card--park-heechan-pledge-desktop work-detail__bento-card--full">
          <div className="work-detail__bento-image-wrapper">
            <img
          ...
          <div className="work-detail__bento-text">
            ...
            <p className="work-detail__bento-description">
              {`거대한 덩치, 대부분의 화력을 막는 키틴질 외골격, 강한 근력 등 전차의 포지션에 위치한 괴수.
강력한 대전차병기로 상대하라는 지침이 있을정도로 위협수준이 높다.`}
      ...
      <section className="work-detail__section work-detail__gallery work-detail__gallery--park-heechan-pledge-desktop">
...
export default ParkHeechanPledgeDesktop;
