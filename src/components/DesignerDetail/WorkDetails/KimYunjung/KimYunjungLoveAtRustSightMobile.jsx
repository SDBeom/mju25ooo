...
const KimYunjungLoveAtRustSightMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--kim-yunjung-love-at-rust-sight-mobile">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--kim-yunjung-love-at-rust-sight-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--kim-yunjung-love-at-rust-sight-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--kim-yunjung-love-at-rust-sight-mobile"
          />
        </div>
      </section>
