 ...
 */
const KimYunjungHelloUniverseTablet = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }
  ...
  return (
    <div className="work-detail work-detail--kim-yunjung-hello-universe-tablet">
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-yunjung-hello-universe-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--kim-yunjung-hello-universe-tablet">
          <div className="work-detail__text-group">
            ...
            <p className="work-detail__lead work-detail__lead--kim-yunjung-hello-universe-tablet">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--kim-yunjung-hello-universe-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--kim-yunjung-hello-universe-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--kim-yunjung-hello-universe-tablet"
          />
        </div>
      </section>
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--kim-yunjung-hello-universe-tablet">
        ...
        <p className="work-detail__feature-text work-detail__feature-text--kim-yunjung-hello-universe-tablet">
