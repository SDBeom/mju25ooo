...
const KimYunjungHelloUniverseMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--kim-yunjung-hello-universe-mobile">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--kim-yunjung-hello-universe-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--kim-yunjung-hello-universe-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--kim-yunjung-hello-universe-mobile"
          />
        </div>
      </section>
