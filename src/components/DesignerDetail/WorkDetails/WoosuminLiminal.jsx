...
const DEFAULT_FOOTER_TEXT = '당신의 감각은 리미널에 접속합니다.';
          ...
          <div className="work-detail__hero-text">
            <div className="work-detail__text-group">
              <div className="work-detail__eyebrow">
                {badgeSrc && (
                  <img src={badgeSrc} alt={badgeAlt || work.genre || designer.role || 'Content'} />
                )}
              ...
              {work.summary && <p className="work-detail__lead">{work.summary}</p>}
            </div>
            <div className="work-detail__ctas">{renderCtas()}</div>
          </div>
          {work.thumbnail && (
              ...
              <li className="work-detail__testimonial-card" key={`testimonial-${noteIndex}`}>
                <div className="work-detail__testimonial-author">
                  <div className="work-detail__testimonial-avatar">
                    <img
                      src={image.src}
                      alt={image.alt || note.title || '추가 기능 아이콘'}
                      loading="lazy"
                    />
                  </div>
