...
import '../../styles/works/SeoDongbeomHiFive/SeoDongbeomHiFiveTablet.css';
...
/**
 * 서동범 - HiFive Tablet 버전
 * Figma 디자인 기반 구현 (800px)
 */
const SeoDongbeomHiFiveTablet = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--seo-dongbeom-hifive-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--seo-dongbeom-hifive-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--seo-dongbeom-hifive-tablet">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--seo-dongbeom-hifive-tablet">HiFive</h2>
            <div className="work-detail__lead work-detail__lead--seo-dongbeom-hifive-tablet">
              <p>HiFive는 프로필이나 관계의 부담 없이, 같은 현장에 모인 사람들이 커서(cursor)가 되어 순간의 분위기(vibe)를 공유하는 실시간 소셜 미디어입니다.</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--seo-dongbeom-hifive-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--seo-dongbeom-hifive-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--seo-dongbeom-hifive-tablet">
          <img
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--seo-dongbeom-hifive-tablet">
        <li className="work-detail__bento-card work-detail__bento-card--seo-dongbeom-hifive-tablet">
      ...
      {/* Pull Quote 1 */}
      <section className="work-detail__section work-detail__quote work-detail__quote--seo-dongbeom-hifive-tablet">
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--seo-dongbeom-hifive-tablet">
      ...
      <section className="work-detail__section work-detail__marquee work-detail__marquee--seo-dongbeom-hifive-tablet">
        {/* Marquee content will be added here if needed */}
      </section>

      {/* Feature Cards 2 */}
      <ul className="work-detail__section work-detail__cards work-detail__cards--seo-dongbeom-hifive-tablet">
        <li className="work-detail__card work-detail__card--seo-dongbeom-hifive-tablet">
...
export default SeoDongbeomHiFiveTablet;
