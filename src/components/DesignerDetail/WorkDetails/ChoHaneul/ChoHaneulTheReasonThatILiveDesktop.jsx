 ...
 */
const ChoHaneulTheReasonThatILiveDesktop = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--cho-haneul-desktop">
        <div className="work-detail__feature-image-wrapper">
          <img
            ...
            alt="Style Frame 2"
            className="work-detail__feature-image"
            onError={(e) => handleImageError(e, choHaneulWork2_05, work.id, 'style-frame-2')}
            loading="lazy"
          />
        </div>
      </section>
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--cho-haneul-desktop">
        <div className="work-detail__feature-image-wrapper">
          <img
            ...
            alt="Style Frame 3"
            className="work-detail__feature-image"
            onError={(e) => handleImageError(e, choHaneulWork2_06, work.id, 'style-frame-3')}
            loading="lazy"
          />
        </div>
      </section>
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--cho-haneul-desktop">
        <div className="work-detail__feature-image-wrapper">
          <img
            ...
            alt="Style Frame 4"
            className="work-detail__feature-image"
            onError={(e) => handleImageError(e, choHaneulWork2_07, work.id, 'style-frame-4')}
            loading="lazy"
          />
        </div>
      </section>
