 ...
 */
const ChoHaneulTheReasonThatILiveDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--cho-haneul-the-reason-that-i-live-desktop">
      {/* Hero Section - 이미지 1번: johaneul_videocontent_work2_01.webp */}
      <section className="work-detail__section work-detail__hero work-detail__hero--cho-haneul-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--cho-haneul-desktop">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--cho-haneul-desktop">
              The Reason that <br />I Live
            </h2>
            <p className="work-detail__lead work-detail__lead--cho-haneul-desktop">
              {work.summary || '히키코모리의 삶를 살아가던 코모리가 친구의 위로와 응원을 통해 다시 세상으로 한걸음 내딛는 이야기'}
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--cho-haneul-desktop">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--cho-haneul-desktop`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--cho-haneul-desktop">
          <img
            key="hero-work2-01"
      ...
      {/* Text Section 1 */}
      <section className="work-detail__section work-detail__text-section work-detail__text-section--cho-haneul-desktop">
        ...
        <div className="work-detail__text-content">
          <p>어두운 방 안, 멈춰있는 시간 속의 코모리.<br />구르미의 따뜻한 손길이 닿는 순간, 멈춰 있던 시간은 다시 흐르기 시작한다.

사라져가던 마음에서, 다시 피어나는 소망으로.<br />"You are the reason that I live"

현대 사회에서 우리는 끊임없이 연결되어 있지만, 역설적으로 동시에 점점 더 외로워지고 있다.<br />관계 속에서 위로받지 못한 감정은 서서히 마음을 닫게 만들고, 결국 자신을 잃게 만든다.

&lt;The Reason that I Live&gt; 는 '진정한 위로'는 무엇인가에<br />대한 질문을 던진다.<br />누군가의 손길, 한마디의 말, 작은 관심이<br />멈춰 있던 마음을 다시 움직이게 만들 수 있다는 믿음에서 시작된 작업이다.

이 이야기가 누군가의 닫힌 마음에 작은 온기로 닿을 수 있기를 바란다.</p>
        </div>
      </section>

      {/* Text Row Section */}
      <ul className="work-detail__section work-detail__text-blocks work-detail__text-blocks--cho-haneul-desktop">
      ...
      {/* 이미지 2번: johaneul_videocontent_work2_02.webp */}
      {/* 이미지 3번: johaneul_videocontent_work2_03.webp */}
      {/* 이미지 4번: johaneul_videocontent_work2_04.webp */}
      <ul className="work-detail__section work-detail__cards work-detail__cards--cho-haneul-desktop">
        <li className="work-detail__card work-detail__card--cho-haneul-1">
        ...
        <li className="work-detail__card work-detail__card--cho-haneul-2">
          <div className="work-detail__card-image-wrapper">
            <img
              key="card-work2-03"
        ...
        <li className="work-detail__card work-detail__card--cho-haneul-3">
          <div className="work-detail__card-image-wrapper">
            <img
              key="card-work2-04"
      ...
      {/* Style Frame Section 1 - 이미지 5번: johaneul_videocontent_work2_05.webp */}
      <section className="work-detail__section work-detail__feature work-detail__feature--cho-haneul-desktop">
      ...
      {/* Style Frame Section 2 - 이미지 6번: johaneul_videocontent_work2_06.webp */}
      <section className="work-detail__section work-detail__feature work-detail__feature--cho-haneul-desktop">
        <div className="work-detail__feature-image-wrapper">
          <img
            key="style-frame-work2-06"
      ...
      {/* Style Frame Section 3 - 이미지 7번: johaneul_videocontent_work2_07.webp */}
      <section className="work-detail__section work-detail__feature work-detail__feature--cho-haneul-desktop">
        <div className="work-detail__feature-image-wrapper">
          <img
            key="style-frame-work2-07"
      ...
      {/* Style Frame Section 4 - 이미지 8번: johaneul_videocontent_work2_08.webp */}
      <section className="work-detail__section work-detail__feature work-detail__feature--cho-haneul-desktop">
        <div className="work-detail__feature-image-wrapper">
          <img
            key="style-frame-work2-08"
...
export default ChoHaneulTheReasonThatILiveDesktop;
