...
/**
 * 조하늘 - 청춘몽(작품1) Desktop 버전
 * Figma 디자인 기반 구현 (1280px)
 */
const ChoHaneulYouthDreamDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }
  ...
  return (
    <div className="work-detail work-detail--cho-haneul-youth-dream-desktop">
        ...
        <div className="work-detail__hero-content work-detail__hero-content--cho-haneul-youth-dream-desktop">
          <div className="work-detail__text-group">
            ...
            <p className="work-detail__lead work-detail__lead--cho-haneul-youth-dream-desktop">
              '청춘'이라는 시간 속에서 느껴지는 감정들을, 음악에 맞춰 비주얼을 실시간으로 믹싱하여 시각적으로 표현한 VJ 퍼포먼스
            </p>
          </div>
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--cho-haneul-youth-dream-desktop">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--cho-haneul-youth-dream-desktop">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--cho-haneul-youth-dream-desktop"
          />
        </div>
      </section>
      ...
      <section className="work-detail__section work-detail__text-section work-detail__text-section--cho-haneul-youth-dream-desktop">
        ...
        <div className="work-detail__text-content">
          <p>청춘몽(靑春夢)은 현실과 이상, 불안과 희망이 공존하는 '청춘'이라는 시간 속에서 느껴지는 감정들을, 음악에 맞춰 비주얼을 실시간으로 믹싱하여 시각적으로 표현한 VJ 퍼포먼스이다.
...
These visual elements were mapped and mixed in real time using Resolume Arena and a MIDI pad controller, resulting in a live performance that allows the audience to experience the complex emotions of youth visually and immersively way.</p>
        </div>
      </section>
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--cho-haneul-youth-dream-desktop">
        <li className="work-detail__card work-detail__card--cho-haneul-youth-dream-1">
          ...
          <div className="work-detail__card-text">
            ...
            <p>청춘의 시간 속에서 느껴지는 감정들을 바탕으로 음악을 선곡하고 믹싱했다.
Selected and mixed music based on the emotions felt within the time of youth.</p>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--cho-haneul-youth-dream-2">
          ...
          <div className="work-detail__card-text">
            ...
            <p>불안과 희망의 감정들을 바탕으로 생성형 AI를 활용해 비주얼을 제작하고 가공했다.
Created and refined visuals using Generative AI based on the emotions of anxiety and hope.</p>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--cho-haneul-youth-dream-3">
          ...
          <div className="work-detail__card-text">
            ...
            <p>제작된 비주얼을 Resolume Arena와 MIDI 컨트롤러에 맵핑하여 실시간으로 믹싱했다.
Mapped the visuals to Resolume Arena and mixed them in real time using a MIDI controller.</p>
          </div>
        </li>
      </ul>
      ...
      {/* Marquee Section */}
      <section className="work-detail__section work-detail__marquee work-detail__marquee--cho-haneul-youth-dream-desktop">
