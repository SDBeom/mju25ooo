 ...
 */
const ChoHaneulYouthDreamMobile = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--cho-haneul-youth-dream-mobile">
        ...
        <div className="work-detail__feature-image-wrapper">
          <img
            ...
            onError={(e) => handleImageError(e, choHaneulWork1_05, work.id, 'style-frame')}
            loading="lazy"
          />
        </div>
      </section>
