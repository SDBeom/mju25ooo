...
import '../../styles/works/ChoHaneulYouthDream/ChoHaneulYouthDreamMobile.css';
...
/**
 * 조하늘 - 청춘몽(작품1) Mobile 버전
 * Figma 디자인 기반 구현 (375px)
 */
const ChoHaneulYouthDreamMobile = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }

  return (
    <div className="work-detail work-detail--cho-haneul-youth-dream-mobile">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--cho-haneul-youth-dream-mobile">
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--cho-haneul-youth-dream-mobile">
          <img
        ...
        <div className="work-detail__hero-content work-detail__hero-content--cho-haneul-youth-dream-mobile">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--cho-haneul-youth-dream-mobile">
              {work.title || '청춘몽'}
            </h2>
            <p className="work-detail__lead work-detail__lead--cho-haneul-youth-dream-mobile">
              {work.summary || "'청춘'이라는 시간 속에서 느껴지는 감정들을, 음악에 맞춰 비주얼을 실시간으로 믹싱하여 시각적으로 표현한 VJ 퍼포먼스"}
            </p>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--cho-haneul-youth-dream-mobile">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--cho-haneul-youth-dream-mobile`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      <section className="work-detail__section work-detail__text-section work-detail__text-section--cho-haneul-youth-dream-mobile">
        <div className="work-detail__text-headline">
          ...
          <h3 className="work-detail__subtitle">청춘몽(靑春夢)</h3>
        </div>
        <div className="work-detail__text-content">
          <p>청춘몽(靑春夢)은 현실과 이상, 불안과 희망이 공존하는 '청춘'이라는 시간 속에서 느껴지는 감정들을, 음악에 맞춰 비주얼을 실시간으로 믹싱하여 시각적으로 표현한 VJ 퍼포먼스이다.</p>
          <p>청춘을 주제로 음악을 선곡해 믹싱한 뒤, 생성형 AI를 활용해 청춘의 정서에 어울리는 비주얼을 생성하고 가공하였다. 이렇게 제작한 시각 요소들을 Resolume Arena와 MIDI 패드 컨트롤러를 활용해 맵핑하고, 실시간으로 믹싱하여, 복합적인 청춘의 감정을 시각적으로 경험할 수 있는 라이브 퍼포먼스로 구현했다.</p>
          <p>&nbsp;</p>
      ...
      {/* Text Blocks Section */}
      <ul className="work-detail__section work-detail__text-blocks work-detail__text-blocks--cho-haneul-youth-dream-mobile">
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--cho-haneul-youth-dream-mobile">
        <li className="work-detail__card work-detail__card--cho-haneul-youth-dream-mobile-1">
          ...
          <div className="work-detail__card-text">
            ...
            <p>청춘의 시간 속에서 느껴지는 감정들을 바탕으로 음악을 선곡하고 믹싱했다.</p>
            <p>Selected and mixed music based on the emotions felt within the time of youth.</p>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--cho-haneul-youth-dream-mobile-2">
          <div className="work-detail__card-image-wrapper">
            <img
          ...
          <div className="work-detail__card-text">
            ...
            <p>불안과 희망의 감정들을 바탕으로 생성형 AI를 활용해 비주얼을 제작하고 가공했다.</p>
            <p>Created and refined visuals using Generative AI based on the emotions of anxiety and hope.</p>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--cho-haneul-youth-dream-mobile-3">
          <div className="work-detail__card-image-wrapper">
            <img
          ...
          <div className="work-detail__card-text">
            ...
            <p>제작된 비주얼을 Resolume Arena와 MIDI 컨트롤러에 맵핑하여 실시간으로 믹싱했다.</p>
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--cho-haneul-youth-dream-mobile">
      ...
      {/* Gallery Section */}
      <section className="work-detail__section work-detail__gallery work-detail__gallery--cho-haneul-youth-dream-mobile">
...
export default ChoHaneulYouthDreamMobile;
