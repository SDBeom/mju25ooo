...
const ChoHaneulYouthDreamTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--cho-haneul-youth-dream-tablet">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--cho-haneul-youth-dream-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--cho-haneul-youth-dream-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--cho-haneul-youth-dream-tablet"
          />
        </div>
      </section>
