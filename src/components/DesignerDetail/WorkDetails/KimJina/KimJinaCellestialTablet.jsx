...
import '../../styles/works/KimJinaCellestial/KimJinaCellestialTablet.css';
...
const KimJinaCellestialTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--kim-jina-cellestial-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-jina-cellestial-tablet">
            ...
            <div className="work-detail__ctas work-detail__ctas--kim-jina-cellestial-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--kim-jina-cellestial-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--kim-jina-cellestial-tablet">
          <img
            src={kimJinaWork2_01}
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--kim-jina-cellestial-tablet">
...
플레이어 캐릭터는 필드를 돌아다니며 자원을 얻고, 에너지를 만든 뒤 오염물을 정화하며 활동 범위를 넓힌다.`}
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--kim-jina-cellestial-tablet">
      ...
      <ul className="work-detail__section work-detail__feature-cards-grid work-detail__feature-cards-grid--kim-jina-cellestial-tablet">
...
export default KimJinaCellestialTablet;
