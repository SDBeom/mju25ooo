 ...
 */
const KimJinaCaravanDesktop = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }
  ...
  return (
    <div className="work-detail work-detail--kim-jina-caravan-desktop">
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-jina-caravan-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--kim-jina-caravan-desktop">
          <div className="work-detail__text-group">
            ...
            <div className="work-detail__lead work-detail__lead--kim-jina-caravan-desktop">
              <p>광활한 사막을 배경으로 한</p>
      ...
      <ul className="work-detail__section work-detail__feature-list work-detail__feature-list--kim-jina-caravan-desktop">
        <li className="work-detail__feature-list-item">
          <div className="work-detail__feature-row-content">
            <h4 className="work-detail__feature-title">사막 진영</h4>
            <div className="work-detail__feature-description">
              <p>붉은색, 주황색, 갈색 메인 컬러. 모티브 동물은 수리부엉이.</p>
            </div>
          </div>
          <div className="work-detail__feature-row-image">
            <img
      ...
      <ul className="work-detail__section work-detail__text-row work-detail__text-row--kim-jina-caravan-desktop">
        ...
        <li className="work-detail__text-block">
          ...
          <div className="work-detail__text-block-content">
            <p>두 공동체는 상반되는 분위기 속 각기 다른 구조를 갖고 있다. 하지만 사막이라는</p>
            <p>동일한 환경에서 서로를 경계하며 장시간 많은 영향를 주고 받았다. 이 내용을 토대로 두 부족의 공통점과 차이점이 어떤 식으로 드러날지 고민하고 서사를 읽어낼 수 있는 디자인을 지향하며 작업했다.</p>
          </div>
        </li>
      </ul>
    </div>
