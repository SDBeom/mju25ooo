 ...
 */
const KimJinaCellestialDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }
  ...
  return (
    <div className="work-detail work-detail--kim-jina-cellestial-desktop">
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-jina-cellestial-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--kim-jina-cellestial-desktop">
          <div className="work-detail__text-group">
            ...
            <p className="work-detail__lead work-detail__lead--kim-jina-cellestial-desktop">
      ...
      <section className="work-detail__section work-detail__feature-cards-grid work-detail__feature-cards-grid--kim-jina-cellestial-desktop">
        <div className="work-detail__feature-cards-grid-item">
