...
const KimJinaCellestialMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--kim-jina-cellestial-mobile">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--kim-jina-cellestial-mobile">
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--kim-jina-cellestial-mobile">
          <img
            src={kimJinaWork2_01}
        ...
        <div className="work-detail__hero-content work-detail__hero-content--kim-jina-cellestial-mobile">
          <div className="work-detail__text-group">
            <h2 className="work-detail__title work-detail__title--kim-jina-cellestial-mobile">Cellestial</h2>
            <div className="work-detail__lead work-detail__lead--kim-jina-cellestial-mobile">
              <p>세포(Cell)를 모티브로 한 캐릭터가</p>
              <p>오염된 행성을 정화하고</p>
              <p>과거 이곳에 무슨 일이 있었는지</p>
              <p>파헤친다.</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--kim-jina-cellestial-mobile">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--kim-jina-cellestial-mobile`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      <section className="work-detail__section work-detail__feature-centered work-detail__feature-centered--kim-jina-cellestial-mobile">
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--kim-jina-cellestial-mobile">
        <div className="work-detail__feature-image-wrapper">
          <img
            src={kimJinaWork2_03}
            alt="오염과 정화의 몽환적 재해석"
        ...
        <div className="work-detail__feature-text">
          ...
          <div className="work-detail__feature-description">
            <p>투명한 막 안의 내용물이 상호작용을 해 에너지를 만든다. 플레이어 캐릭터는 필드를 돌아다니며 자원을 얻고, 에너지를 만든 뒤 오염물을 정화하며</p>
            <p>활동 범위를 넓힌다.</p>
          </div>
        </div>
      </section>
      ...
      <ul className="work-detail__section work-detail__feature-cards work-detail__feature-cards--kim-jina-cellestial-mobile">
      ...
      {/* Feature Cards Grid Section 2 - Detail Cuts and Monster */}
      <ul className="work-detail__section work-detail__feature-cards-grid work-detail__feature-cards-grid--kim-jina-cellestial-mobile">
...
export default KimJinaCellestialMobile;
