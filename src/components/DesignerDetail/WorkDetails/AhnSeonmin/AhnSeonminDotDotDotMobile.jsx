...
const AhnSeonminDotDotDotMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--ahn-seonmin-dot-dot-dot-mobile">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--ahn-seonmin-dot-dot-dot-mobile">
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--ahn-seonmin-dot-dot-dot-mobile">
          <img
        ...
        <div className="work-detail__hero-content work-detail__hero-content--ahn-seonmin-dot-dot-dot-mobile">
          <div className="work-detail__text-group work-detail__text-group--center">
            <h2 className="work-detail__title work-detail__title--ahn-seonmin-dot-dot-dot-mobile">점점점</h2>
            <div className="work-detail__lead work-detail__lead--ahn-seonmin-dot-dot-dot-mobile">
              <p>서로 다른 24개의 점이 만나 연결되고, 확장됩니다. 각자의 개성이 모여 하나의 흐름을 만들고, 그 안에서 새로운 세계가 공유됩니다. 지금, 점과 점 사이에서 펼쳐지는 변화의 순간을 영상으로 만나보세요!</p>
            </div>
          </div>
          {ctas && Array.isArray(ctas) && ctas.length > 0 && (
            <div className="work-detail__ctas work-detail__ctas--ahn-seonmin-dot-dot-dot-mobile">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--ahn-seonmin-dot-dot-dot-mobile`}
                  onClick={onClick}
                >
                  {label}
                </button>
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--ahn-seonmin-dot-dot-dot-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--ahn-seonmin-dot-dot-dot-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--ahn-seonmin-dot-dot-dot-mobile"
          />
        </div>
      </section>

      {/* Feature 1 Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--ahn-seonmin-dot-dot-dot-mobile">
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--ahn-seonmin-dot-dot-dot-mobile">
        <li className="work-detail__feature-row work-detail__feature-row--ahn-seonmin-dot-dot-dot-mobile">
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--ahn-seonmin-dot-dot-dot-mobile">
        <li className="work-detail__bento-card work-detail__bento-card--ahn-seonmin-dot-dot-dot-mobile">
        ...
        <li className="work-detail__bento-card work-detail__bento-card--ahn-seonmin-dot-dot-dot-mobile work-detail__bento-card--wide">
          <div className="work-detail__bento-card-image-wrapper">
            <img
...
export default AhnSeonminDotDotDotMobile;
