...
import '../../styles/works/AhnSeonminDotDotDot/AhnSeonminDotDotDotTablet.css';
...
const AhnSeonminDotDotDotTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--ahn-seonmin-dot-dot-dot-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--ahn-seonmin-dot-dot-dot-tablet">
...
지금, 점과 점 사이에서 펼쳐지는 변화의 순간을 영상으로 만나보세요!`}
            ...
            <div className="work-detail__ctas work-detail__ctas--ahn-seonmin-dot-dot-dot-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--ahn-seonmin-dot-dot-dot-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--ahn-seonmin-dot-dot-dot-tablet">
          <img
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--ahn-seonmin-dot-dot-dot-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--ahn-seonmin-dot-dot-dot-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--ahn-seonmin-dot-dot-dot-tablet"
          />
        </div>
      </section>

      {/* Feature 1 Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--ahn-seonmin-dot-dot-dot-tablet">
      ...
      <ul className="work-detail__section work-detail__feature-rows work-detail__feature-rows--ahn-seonmin-dot-dot-dot-tablet">
      ...
      <ul className="work-detail__section work-detail__bento work-detail__bento--ahn-seonmin-dot-dot-dot-tablet">
        <li className="work-detail__bento-card work-detail__bento-card--ahn-seonmin-dot-dot-dot-tablet">
        ...
        <li className="work-detail__bento-card work-detail__bento-card--ahn-seonmin-dot-dot-dot-tablet work-detail__bento-card--wide">
          <div className="work-detail__bento-card-image-wrapper">
            <img
...
export default AhnSeonminDotDotDotTablet;
