 ...
 */
const LeeDayoungPlottingRoomTablet = ({ work, designer, badgeSrc, badgeAlt, ctas }) => {
  if (!work || !designer) {
    return null;
  }
    ...
    <div className="work-detail work-detail--leedayoung-plottingroom-tablet">
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--leedayoung-plottingroom-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--leedayoung-plottingroom-tablet">
          <div className="work-detail__text-group">
            ...
            <div className="work-detail__lead work-detail__lead--leedayoung-plottingroom-tablet">
              <p className="mb-0">분야를 넘나드는 다양한 작가들이 매회 새로운  조합으로 모여 자신의 작품과</p>
              <p className="mb-0">글쓰기 과정, 그리고 좋아하는 소재에</p>
              <p className="mb-0">대해 깊이 이야기를 나누며, 한 회차의</p>
              <p className="mb-0">마지막에는 즉석에서 새로운 이야기를</p>
              <p className="mb-0">창작해 선보이는 가상의 토크 예능</p>
              <p>&lt;플롯팅룸&gt;의 타이틀 시퀀스 제작한 프로젝트이다.</p>
            </div>
          </div>
      ...
      <section className="work-detail__section work-detail__text-section work-detail__text-section--leedayoung-plottingroom-tablet">
        ...
        <div className="work-detail__text-section-description">
          ...
          <p className="mb-0">&nbsp;</p>
          <p className="mb-0">이러한 제목의 의미와 프로그램의 콘셉트를 시각적으로 표현하기 위해, 다양한 시대와 방식으로</p>
          <p className="mb-0">이야기를 만들어가는 작가들의 모습을 그리고, 그들이 써 내려간 이야기들이 실사처럼 살아 움직이는</p>
          <p className="mb-0">장면을 연출하였다. 작가들의 소통과 창작의 순간들이 모여 또 하나의 서사를 이루고, 그 서사로 방이 채워지는 과정을 통해 프로그램의 주제를 완성하고자 하였다.</p>
          <p className="mb-0"> </p>
          <p className="mb-0">전반적인 장면은 2D로 구성하여 서정적인 분위기를 구현하였다. 평면적인 화면에서도 밀도가</p>
          <p className="mb-0">느껴지도록 그레인 그라데이션, 양감, 텍처링에 중점을 두었다. 타이틀 레터링은 토크 예능의</p>
          <p className="mb-0">경쾌함을 담되, 전체 시퀀의 서정적인 톤과 조화를 이루며 프로그램의 개성을 시각적으로</p>
          <p>드러내고자 하였다.</p>
        </div>
      </section>
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--leedayoung-plottingroom-tablet">
        ...
        <li className="work-detail__card work-detail__card--leedayoung-plottingroom-tablet">
          ...
          <div className="work-detail__card-text">
            ...
            <div className="work-detail__card-description">
              <p className="mb-0">타자기로 글을 써내려가는</p>
              <p>모습으로 변화한다.</p>
            </div>
          </div>
        </li>
        <li className="work-detail__card work-detail__card--leedayoung-plottingroom-tablet">
          ...
          <div className="work-detail__card-text">
            ...
            <div className="work-detail__card-description">
              <p className="mb-0">노트북 키보드로 글을</p>
              <p>써내려가는 모습이 보여진다.</p>
            </div>
          </div>
        </li>
          ...
          <div className="work-detail__feature-content">
            <div className="work-detail__text-group">
              <h4 className="work-detail__feature-title">
                <span className="block mb-0">작가들의 글이 토리보드</span>
                <span className="block">속으로</span>
              </h4>
              <div className="work-detail__feature-description">
                <p className="mb-0">자신의 방식대로 써내려간 글들이 토리보드 속으로 하나 둘 자리잡으며 작가들이 글로</p>
                <p className="mb-0">하여금 하나의 새로운 세상을 창조해내는</p>
                <p>모습을 보여준다.</p>
              </div>
            </div>
          </div>
        ...
        <li className="work-detail__feature-row work-detail__feature-row--leedayoung-plottingroom-tablet">
          ...
          <div className="work-detail__feature-content">
            <div className="work-detail__text-group">
              ...
              <p className="work-detail__feature-description">토리보드를 통해 생명력을 갖게된 인물들이 살아움직이며 청춘 멜로드라마의 한 장면으로 보여진다.</p>
            </div>
          </div>
        </li>
      </ul>
        ...
        <li className="work-detail__feature-row work-detail__feature-row--leedayoung-plottingroom-tablet">
          ...
          <div className="work-detail__feature-content">
            <div className="work-detail__text-group">
              ...
              <div className="work-detail__feature-description">
                <p className="mb-0">또 다시 판타지 영화의 한 장면로 변화하며</p>
                <p className="mb-0">작가로부터 생명력을 얻게된 다양한 분야와</p>
                <p>장르의 이야기들이 보여진다.</p>
              </div>
            </div>
          </div>
      ...
      <section className="work-detail__section work-detail__feature work-detail__feature--leedayoung-plottingroom-tablet">
        ...
        <div className="work-detail__feature-text">
          ...
          <div className="work-detail__feature-description">
            <p className="mb-0">이런 작가들이 한 방에 모여 이야기를 나누며 또 하나의 서사를 이루고, 그 서사들로 채워진 방은,</p>
            <p>비로소 &lt;플롯팅룸&gt;이 된다.</p>
          </div>
        </div>
      </section>
