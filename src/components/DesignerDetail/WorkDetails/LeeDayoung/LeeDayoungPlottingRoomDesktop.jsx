 ...
 */
const LeeDayoungPlottingRoomDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--leedayoung-plottingroom-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--leedayoung-plottingroom-desktop">
          <div className="work-detail__text-group">
            ...
            <p className="work-detail__lead work-detail__lead--leedayoung-plottingroom-desktop">
