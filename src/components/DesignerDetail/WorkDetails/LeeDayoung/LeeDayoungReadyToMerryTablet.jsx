...
import '../../styles/works/LeeDayoungReadyToMerry/LeeDayoungReadyToMerryTablet.css';
...
const LeeDayoungReadyToMerryTablet = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--leedayoung-ready-to-merry-tablet">
      {/* Hero Section */}
      <section className="work-detail__section work-detail__hero work-detail__hero--leedayoung-ready-to-merry-tablet">
        <div className="work-detail__hero-content work-detail__hero-content--leedayoung-ready-to-merry-tablet">
...
`}
            ...
            <div className="work-detail__ctas work-detail__ctas--leedayoung-ready-to-merry-tablet">
              {ctas.map(({ label, onClick, variant = 'primary' }) => (
                <button
                  key={label}
                  type="button"
                  className={`work-detail__cta work-detail__cta--${variant === 'secondary' ? 'secondary' : 'primary'} work-detail__cta--leedayoung-ready-to-merry-tablet`}
                  onClick={onClick}
                >
                  {label}
                </button>
        ...
        <div className="work-detail__hero-image-wrapper work-detail__hero-image-wrapper--leedayoung-ready-to-merry-tablet">
          <img
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--leedayoung-ready-to-merry-tablet">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--leedayoung-ready-to-merry-tablet">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--leedayoung-ready-to-merry-tablet"
          />
        </div>
      </section>

      {/* Text Section */}
      <section className="work-detail__section work-detail__text-section work-detail__text-section--leedayoung-ready-to-merry-tablet">
...
우편함'이라는 콘셉트로, 내부는 서랍형 구조로 구성되어 각 곡의 굿즈를 개별적으로 담을 수 있도록 디자인된 형태이다.`}</p>
      ...
      {/* Feature Section */}
      <section className="work-detail__section work-detail__feature work-detail__feature--leedayoung-ready-to-merry-tablet">
        <div className="work-detail__feature-image-wrapper work-detail__feature-image-wrapper--leedayoung-ready-to-merry-tablet">
          <img
...
구성하였다.`}</p>
        ...
        <li className="work-detail__feature-row work-detail__feature-row--reverse work-detail__feature-row--leedayoung-ready-to-merry-tablet">
          <div className="work-detail__feature-image-wrapper">
            <img
...
크리스마스 트리에 장식 오너먼트로 활용할 수 있다.`}</p>
      ...
      <ul className="work-detail__section work-detail__cards work-detail__cards--leedayoung-ready-to-merry-tablet">
...
export default LeeDayoungReadyToMerryTablet;
