 ...
 */
const LeeDayoungReadyToMerryDesktop = ({ work, designer, ctas }) => {
  if (!work || !designer) {
    return null;
  }
      ...
      <section className="work-detail__section work-detail__hero work-detail__hero--leedayoung-ready-to-merry-desktop">
        <div className="work-detail__hero-content work-detail__hero-content--leedayoung-ready-to-merry-desktop">
          <div className="work-detail__text-group">
            ...
            <p className="work-detail__lead work-detail__lead--leedayoung-ready-to-merry-desktop">
...
`}
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--leedayoung-ready-to-merry-desktop">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--leedayoung-ready-to-merry-desktop">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/UqxMcjEY6sw?si=5zGyIfRR7pyp9DqN&controls=0"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerPolicy="strict-origin-when-cross-origin"
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--leedayoung-ready-to-merry-desktop"
          />
        </div>
      </section>
