...
const LeeDayoungReadyToMerryMobile = ({ work, designer, ctas }) => {
  ...
  return (
    <div className="work-detail work-detail--leedayoung-ready-to-merry-mobile">
      ...
      <section className="work-detail__section work-detail__video-section work-detail__video-section--leedayoung-ready-to-merry-mobile">
        <div className="work-detail__video-wrapper work-detail__video-wrapper--leedayoung-ready-to-merry-mobile">
          <iframe
            width="560"
            height="315"
            ...
            allowFullScreen
            className="work-detail__video-iframe work-detail__video-iframe--leedayoung-ready-to-merry-mobile"
          />
        </div>
      </section>
